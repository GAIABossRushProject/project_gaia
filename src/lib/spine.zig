...
pub const struct_spFloatArray = extern struct {
    size: c_int = @import("std").mem.zeroes(c_int),
    capacity: c_int = @import("std").mem.zeroes(c_int),
    items: [*c]f32 = @import("std").mem.zeroes([*c]f32),
};
pub const spFloatArray = struct_spFloatArray;
pub extern fn spFloatArray_create(initialCapacity: c_int) [*c]spFloatArray;
pub extern fn spFloatArray_dispose(self: [*c]spFloatArray) void;
pub extern fn spFloatArray_clear(self: [*c]spFloatArray) void;
pub extern fn spFloatArray_setSize(self: [*c]spFloatArray, newSize: c_int) [*c]spFloatArray;
pub extern fn spFloatArray_ensureCapacity(self: [*c]spFloatArray, newCapacity: c_int) void;
pub extern fn spFloatArray_add(self: [*c]spFloatArray, value: f32) void;
pub extern fn spFloatArray_addAll(self: [*c]spFloatArray, other: [*c]spFloatArray) void;
pub extern fn spFloatArray_addAllValues(self: [*c]spFloatArray, values: [*c]f32, offset: c_int, count: c_int) void;
pub extern fn spFloatArray_removeAt(self: [*c]spFloatArray, index: c_int) void;
pub extern fn spFloatArray_contains(self: [*c]spFloatArray, value: f32) c_int;
pub extern fn spFloatArray_pop(self: [*c]spFloatArray) f32;
pub extern fn spFloatArray_peek(self: [*c]spFloatArray) f32;
pub const struct_spIntArray = extern struct {
    size: c_int = @import("std").mem.zeroes(c_int),
    capacity: c_int = @import("std").mem.zeroes(c_int),
    items: [*c]c_int = @import("std").mem.zeroes([*c]c_int),
};
pub const spIntArray = struct_spIntArray;
pub extern fn spIntArray_create(initialCapacity: c_int) [*c]spIntArray;
pub extern fn spIntArray_dispose(self: [*c]spIntArray) void;
pub extern fn spIntArray_clear(self: [*c]spIntArray) void;
pub extern fn spIntArray_setSize(self: [*c]spIntArray, newSize: c_int) [*c]spIntArray;
pub extern fn spIntArray_ensureCapacity(self: [*c]spIntArray, newCapacity: c_int) void;
pub extern fn spIntArray_add(self: [*c]spIntArray, value: c_int) void;
pub extern fn spIntArray_addAll(self: [*c]spIntArray, other: [*c]spIntArray) void;
pub extern fn spIntArray_addAllValues(self: [*c]spIntArray, values: [*c]c_int, offset: c_int, count: c_int) void;
pub extern fn spIntArray_removeAt(self: [*c]spIntArray, index: c_int) void;
pub extern fn spIntArray_contains(self: [*c]spIntArray, value: c_int) c_int;
pub extern fn spIntArray_pop(self: [*c]spIntArray) c_int;
pub extern fn spIntArray_peek(self: [*c]spIntArray) c_int;
pub const struct_spShortArray = extern struct {
    size: c_int = @import("std").mem.zeroes(c_int),
    capacity: c_int = @import("std").mem.zeroes(c_int),
    items: [*c]c_short = @import("std").mem.zeroes([*c]c_short),
};
pub const spShortArray = struct_spShortArray;
pub extern fn spShortArray_create(initialCapacity: c_int) [*c]spShortArray;
pub extern fn spShortArray_dispose(self: [*c]spShortArray) void;
pub extern fn spShortArray_clear(self: [*c]spShortArray) void;
pub extern fn spShortArray_setSize(self: [*c]spShortArray, newSize: c_int) [*c]spShortArray;
pub extern fn spShortArray_ensureCapacity(self: [*c]spShortArray, newCapacity: c_int) void;
pub extern fn spShortArray_add(self: [*c]spShortArray, value: c_short) void;
pub extern fn spShortArray_addAll(self: [*c]spShortArray, other: [*c]spShortArray) void;
pub extern fn spShortArray_addAllValues(self: [*c]spShortArray, values: [*c]c_short, offset: c_int, count: c_int) void;
pub extern fn spShortArray_removeAt(self: [*c]spShortArray, index: c_int) void;
pub extern fn spShortArray_contains(self: [*c]spShortArray, value: c_short) c_int;
pub extern fn spShortArray_pop(self: [*c]spShortArray) c_short;
pub extern fn spShortArray_peek(self: [*c]spShortArray) c_short;
pub const struct_spUnsignedShortArray = extern struct {
    size: c_int = @import("std").mem.zeroes(c_int),
    capacity: c_int = @import("std").mem.zeroes(c_int),
    items: [*c]c_ushort = @import("std").mem.zeroes([*c]c_ushort),
};
pub const spUnsignedShortArray = struct_spUnsignedShortArray;
pub extern fn spUnsignedShortArray_create(initialCapacity: c_int) [*c]spUnsignedShortArray;
pub extern fn spUnsignedShortArray_dispose(self: [*c]spUnsignedShortArray) void;
pub extern fn spUnsignedShortArray_clear(self: [*c]spUnsignedShortArray) void;
pub extern fn spUnsignedShortArray_setSize(self: [*c]spUnsignedShortArray, newSize: c_int) [*c]spUnsignedShortArray;
pub extern fn spUnsignedShortArray_ensureCapacity(self: [*c]spUnsignedShortArray, newCapacity: c_int) void;
pub extern fn spUnsignedShortArray_add(self: [*c]spUnsignedShortArray, value: c_ushort) void;
pub extern fn spUnsignedShortArray_addAll(self: [*c]spUnsignedShortArray, other: [*c]spUnsignedShortArray) void;
pub extern fn spUnsignedShortArray_addAllValues(self: [*c]spUnsignedShortArray, values: [*c]c_ushort, offset: c_int, count: c_int) void;
pub extern fn spUnsignedShortArray_removeAt(self: [*c]spUnsignedShortArray, index: c_int) void;
pub extern fn spUnsignedShortArray_contains(self: [*c]spUnsignedShortArray, value: c_ushort) c_int;
pub extern fn spUnsignedShortArray_pop(self: [*c]spUnsignedShortArray) c_ushort;
pub extern fn spUnsignedShortArray_peek(self: [*c]spUnsignedShortArray) c_ushort;
pub const struct_spArrayFloatArray = extern struct {
    size: c_int = @import("std").mem.zeroes(c_int),
    capacity: c_int = @import("std").mem.zeroes(c_int),
    items: [*c][*c]spFloatArray = @import("std").mem.zeroes([*c][*c]spFloatArray),
};
pub const spArrayFloatArray = struct_spArrayFloatArray;
pub extern fn spArrayFloatArray_create(initialCapacity: c_int) [*c]spArrayFloatArray;
pub extern fn spArrayFloatArray_dispose(self: [*c]spArrayFloatArray) void;
pub extern fn spArrayFloatArray_clear(self: [*c]spArrayFloatArray) void;
pub extern fn spArrayFloatArray_setSize(self: [*c]spArrayFloatArray, newSize: c_int) [*c]spArrayFloatArray;
pub extern fn spArrayFloatArray_ensureCapacity(self: [*c]spArrayFloatArray, newCapacity: c_int) void;
pub extern fn spArrayFloatArray_add(self: [*c]spArrayFloatArray, value: [*c]spFloatArray) void;
pub extern fn spArrayFloatArray_addAll(self: [*c]spArrayFloatArray, other: [*c]spArrayFloatArray) void;
pub extern fn spArrayFloatArray_addAllValues(self: [*c]spArrayFloatArray, values: [*c][*c]spFloatArray, offset: c_int, count: c_int) void;
pub extern fn spArrayFloatArray_removeAt(self: [*c]spArrayFloatArray, index: c_int) void;
pub extern fn spArrayFloatArray_contains(self: [*c]spArrayFloatArray, value: [*c]spFloatArray) c_int;
pub extern fn spArrayFloatArray_pop(self: [*c]spArrayFloatArray) [*c]spFloatArray;
pub extern fn spArrayFloatArray_peek(self: [*c]spArrayFloatArray) [*c]spFloatArray;
pub const struct_spArrayShortArray = extern struct {
    size: c_int = @import("std").mem.zeroes(c_int),
    capacity: c_int = @import("std").mem.zeroes(c_int),
    items: [*c][*c]spShortArray = @import("std").mem.zeroes([*c][*c]spShortArray),
};
pub const spArrayShortArray = struct_spArrayShortArray;
pub extern fn spArrayShortArray_create(initialCapacity: c_int) [*c]spArrayShortArray;
pub extern fn spArrayShortArray_dispose(self: [*c]spArrayShortArray) void;
pub extern fn spArrayShortArray_clear(self: [*c]spArrayShortArray) void;
pub extern fn spArrayShortArray_setSize(self: [*c]spArrayShortArray, newSize: c_int) [*c]spArrayShortArray;
pub extern fn spArrayShortArray_ensureCapacity(self: [*c]spArrayShortArray, newCapacity: c_int) void;
pub extern fn spArrayShortArray_add(self: [*c]spArrayShortArray, value: [*c]spShortArray) void;
pub extern fn spArrayShortArray_addAll(self: [*c]spArrayShortArray, other: [*c]spArrayShortArray) void;
pub extern fn spArrayShortArray_addAllValues(self: [*c]spArrayShortArray, values: [*c][*c]spShortArray, offset: c_int, count: c_int) void;
pub extern fn spArrayShortArray_removeAt(self: [*c]spArrayShortArray, index: c_int) void;
pub extern fn spArrayShortArray_contains(self: [*c]spArrayShortArray, value: [*c]spShortArray) c_int;
pub extern fn spArrayShortArray_pop(self: [*c]spArrayShortArray) [*c]spShortArray;
pub extern fn spArrayShortArray_peek(self: [*c]spArrayShortArray) [*c]spShortArray;
pub const struct_spEventData = extern struct {
    name: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    intValue: c_int = @import("std").mem.zeroes(c_int),
    floatValue: f32 = @import("std").mem.zeroes(f32),
    stringValue: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    audioPath: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    volume: f32 = @import("std").mem.zeroes(f32),
    balance: f32 = @import("std").mem.zeroes(f32),
};
pub const spEventData = struct_spEventData;
pub extern fn spEventData_create(name: [*c]const u8) [*c]spEventData;
pub extern fn spEventData_dispose(self: [*c]spEventData) void;
pub const struct_spEvent = extern struct {
    data: [*c]spEventData = @import("std").mem.zeroes([*c]spEventData),
...
pub const spEvent = struct_spEvent;
pub extern fn spEvent_create(time: f32, data: [*c]spEventData) [*c]spEvent;
pub extern fn spEvent_dispose(self: [*c]spEvent) void;
pub const struct_spAttachmentLoader = extern struct {
    error1: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    error2: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    vtable: ?*const anyopaque = @import("std").mem.zeroes(?*const anyopaque),
};
pub const SP_ATTACHMENT_REGION: c_int = 0;
pub const SP_ATTACHMENT_BOUNDING_BOX: c_int = 1;
pub const SP_ATTACHMENT_MESH: c_int = 2;
pub const SP_ATTACHMENT_LINKED_MESH: c_int = 3;
pub const SP_ATTACHMENT_PATH: c_int = 4;
pub const SP_ATTACHMENT_POINT: c_int = 5;
pub const SP_ATTACHMENT_CLIPPING: c_int = 6;
pub const spAttachmentType = c_uint;
pub const struct_spAttachment = extern struct {
    name: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    type: spAttachmentType = @import("std").mem.zeroes(spAttachmentType),
    vtable: ?*const anyopaque = @import("std").mem.zeroes(?*const anyopaque),
    refCount: c_int = @import("std").mem.zeroes(c_int),
    attachmentLoader: [*c]struct_spAttachmentLoader = @import("std").mem.zeroes([*c]struct_spAttachmentLoader),
};
pub const spAttachment = struct_spAttachment;
pub extern fn spAttachment_dispose(self: [*c]spAttachment) void;
pub extern fn spAttachment_copy(self: [*c]spAttachment) [*c]spAttachment;
pub const struct_spColor = extern struct {
...
pub const spColor = struct_spColor;
pub extern fn spColor_create() [*c]spColor;
pub extern fn spColor_dispose(self: [*c]spColor) void;
pub extern fn spColor_setFromFloats(color: [*c]spColor, r: f32, g: f32, b: f32, a: f32) void;
pub extern fn spColor_setFromFloats3(self: [*c]spColor, r: f32, g: f32, b: f32) void;
pub extern fn spColor_setFromColor(color: [*c]spColor, otherColor: [*c]spColor) void;
pub extern fn spColor_setFromColor3(self: [*c]spColor, otherColor: [*c]spColor) void;
pub extern fn spColor_addFloats(color: [*c]spColor, r: f32, g: f32, b: f32, a: f32) void;
pub extern fn spColor_addFloats3(color: [*c]spColor, r: f32, g: f32, b: f32) void;
pub extern fn spColor_addColor(color: [*c]spColor, otherColor: [*c]spColor) void;
pub extern fn spColor_clamp(color: [*c]spColor) void;
pub const SP_INHERIT_NORMAL: c_int = 0;
pub const SP_INHERIT_ONLYTRANSLATION: c_int = 1;
pub const SP_INHERIT_NOROTATIONORREFLECTION: c_int = 2;
pub const SP_INHERIT_NOSCALE: c_int = 3;
pub const SP_INHERIT_NOSCALEORREFLECTION: c_int = 4;
pub const spInherit = c_uint;
pub const spBoneData = struct_spBoneData;
pub const struct_spBoneData = extern struct {
    index: c_int = @import("std").mem.zeroes(c_int),
    name: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    parent: [*c]spBoneData = @import("std").mem.zeroes([*c]spBoneData),
    ...
    shearX: f32 = @import("std").mem.zeroes(f32),
    shearY: f32 = @import("std").mem.zeroes(f32),
    inherit: spInherit = @import("std").mem.zeroes(spInherit),
    skinRequired: c_int = @import("std").mem.zeroes(c_int),
    color: spColor = @import("std").mem.zeroes(spColor),
    icon: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    visible: c_int = @import("std").mem.zeroes(c_int),
};
pub extern fn spBoneData_create(index: c_int, name: [*c]const u8, parent: [*c]spBoneData) [*c]spBoneData;
pub extern fn spBoneData_dispose(self: [*c]spBoneData) void;
pub const SP_PHYSICS_NONE: c_int = 0;
pub const SP_PHYSICS_RESET: c_int = 1;
pub const SP_PHYSICS_UPDATE: c_int = 2;
pub const SP_PHYSICS_POSE: c_int = 3;
pub const spPhysics = c_uint;
pub const struct_spSlotData = extern struct {
    index: c_int = @import("std").mem.zeroes(c_int),
    name: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    boneData: [*c]spBoneData = @import("std").mem.zeroes([*c]spBoneData),
    attachmentName: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    color: spColor = @import("std").mem.zeroes(spColor),
    darkColor: [*c]spColor = @import("std").mem.zeroes([*c]spColor),
    blendMode: spBlendMode = @import("std").mem.zeroes(spBlendMode),
    visible: c_int = @import("std").mem.zeroes(c_int),
};
pub const spSlotData = struct_spSlotData;
pub const struct_spBoneDataArray = extern struct {
    size: c_int = @import("std").mem.zeroes(c_int),
    capacity: c_int = @import("std").mem.zeroes(c_int),
    items: [*c][*c]spBoneData = @import("std").mem.zeroes([*c][*c]spBoneData),
};
pub const spBoneDataArray = struct_spBoneDataArray;
pub const struct_spIkConstraintData = extern struct {
    name: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    order: c_int = @import("std").mem.zeroes(c_int),
    skinRequired: c_int = @import("std").mem.zeroes(c_int),
    bonesCount: c_int = @import("std").mem.zeroes(c_int),
    bones: [*c][*c]spBoneData = @import("std").mem.zeroes([*c][*c]spBoneData),
    target: [*c]spBoneData = @import("std").mem.zeroes([*c]spBoneData),
    bendDirection: c_int = @import("std").mem.zeroes(c_int),
    compress: c_int = @import("std").mem.zeroes(c_int),
    stretch: c_int = @import("std").mem.zeroes(c_int),
    uniform: c_int = @import("std").mem.zeroes(c_int),
    mix: f32 = @import("std").mem.zeroes(f32),
    softness: f32 = @import("std").mem.zeroes(f32),
};
pub const spIkConstraintData = struct_spIkConstraintData;
pub const struct_spIkConstraintDataArray = extern struct {
    size: c_int = @import("std").mem.zeroes(c_int),
    capacity: c_int = @import("std").mem.zeroes(c_int),
    items: [*c][*c]spIkConstraintData = @import("std").mem.zeroes([*c][*c]spIkConstraintData),
};
pub const spIkConstraintDataArray = struct_spIkConstraintDataArray;
pub const struct_spTransformConstraintData = extern struct {
    name: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    order: c_int = @import("std").mem.zeroes(c_int),
    skinRequired: c_int = @import("std").mem.zeroes(c_int),
    bonesCount: c_int = @import("std").mem.zeroes(c_int),
    bones: [*c][*c]spBoneData = @import("std").mem.zeroes([*c][*c]spBoneData),
    target: [*c]spBoneData = @import("std").mem.zeroes([*c]spBoneData),
    mixRotate: f32 = @import("std").mem.zeroes(f32),
    mixX: f32 = @import("std").mem.zeroes(f32),
    mixY: f32 = @import("std").mem.zeroes(f32),
    mixScaleX: f32 = @import("std").mem.zeroes(f32),
    mixScaleY: f32 = @import("std").mem.zeroes(f32),
    mixShearY: f32 = @import("std").mem.zeroes(f32),
    offsetRotation: f32 = @import("std").mem.zeroes(f32),
    offsetX: f32 = @import("std").mem.zeroes(f32),
    offsetY: f32 = @import("std").mem.zeroes(f32),
    offsetScaleX: f32 = @import("std").mem.zeroes(f32),
    offsetScaleY: f32 = @import("std").mem.zeroes(f32),
    offsetShearY: f32 = @import("std").mem.zeroes(f32),
    relative: c_int = @import("std").mem.zeroes(c_int),
    local: c_int = @import("std").mem.zeroes(c_int),
};
pub const spTransformConstraintData = struct_spTransformConstraintData;
pub const struct_spTransformConstraintDataArray = extern struct {
    size: c_int = @import("std").mem.zeroes(c_int),
    capacity: c_int = @import("std").mem.zeroes(c_int),
    items: [*c][*c]spTransformConstraintData = @import("std").mem.zeroes([*c][*c]spTransformConstraintData),
};
pub const spTransformConstraintDataArray = struct_spTransformConstraintDataArray;
pub const struct_spPathConstraintData = extern struct {
    name: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    order: c_int = @import("std").mem.zeroes(c_int),
    skinRequired: c_int = @import("std").mem.zeroes(c_int),
    bonesCount: c_int = @import("std").mem.zeroes(c_int),
    bones: [*c][*c]spBoneData = @import("std").mem.zeroes([*c][*c]spBoneData),
    target: [*c]spSlotData = @import("std").mem.zeroes([*c]spSlotData),
    positionMode: spPositionMode = @import("std").mem.zeroes(spPositionMode),
    spacingMode: spSpacingMode = @import("std").mem.zeroes(spSpacingMode),
    rotateMode: spRotateMode = @import("std").mem.zeroes(spRotateMode),
    offsetRotation: f32 = @import("std").mem.zeroes(f32),
...
pub const spPathConstraintData = struct_spPathConstraintData;
pub const struct_spPathConstraintDataArray = extern struct {
    size: c_int = @import("std").mem.zeroes(c_int),
    capacity: c_int = @import("std").mem.zeroes(c_int),
    items: [*c][*c]spPathConstraintData = @import("std").mem.zeroes([*c][*c]spPathConstraintData),
};
pub const spPathConstraintDataArray = struct_spPathConstraintDataArray;
pub const struct_spPhysicsConstraintData = extern struct {
    name: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    order: c_int = @import("std").mem.zeroes(c_int),
    skinRequired: c_int = @import("std").mem.zeroes(c_int),
    bone: [*c]spBoneData = @import("std").mem.zeroes([*c]spBoneData),
    x: f32 = @import("std").mem.zeroes(f32),
    y: f32 = @import("std").mem.zeroes(f32),
    rotate: f32 = @import("std").mem.zeroes(f32),
    scaleX: f32 = @import("std").mem.zeroes(f32),
    shearX: f32 = @import("std").mem.zeroes(f32),
    limit: f32 = @import("std").mem.zeroes(f32),
    step: f32 = @import("std").mem.zeroes(f32),
    inertia: f32 = @import("std").mem.zeroes(f32),
    strength: f32 = @import("std").mem.zeroes(f32),
    damping: f32 = @import("std").mem.zeroes(f32),
    massInverse: f32 = @import("std").mem.zeroes(f32),
    wind: f32 = @import("std").mem.zeroes(f32),
    gravity: f32 = @import("std").mem.zeroes(f32),
    mix: f32 = @import("std").mem.zeroes(f32),
    inertiaGlobal: c_int = @import("std").mem.zeroes(c_int),
    strengthGlobal: c_int = @import("std").mem.zeroes(c_int),
    dampingGlobal: c_int = @import("std").mem.zeroes(c_int),
    massGlobal: c_int = @import("std").mem.zeroes(c_int),
    windGlobal: c_int = @import("std").mem.zeroes(c_int),
    gravityGlobal: c_int = @import("std").mem.zeroes(c_int),
    mixGlobal: c_int = @import("std").mem.zeroes(c_int),
};
pub const spPhysicsConstraintData = struct_spPhysicsConstraintData;
pub const struct_spPhysicsConstraintDataArray = extern struct {
    size: c_int = @import("std").mem.zeroes(c_int),
    capacity: c_int = @import("std").mem.zeroes(c_int),
    items: [*c][*c]spPhysicsConstraintData = @import("std").mem.zeroes([*c][*c]spPhysicsConstraintData),
};
pub const spPhysicsConstraintDataArray = struct_spPhysicsConstraintDataArray;
pub const struct_spSkin = extern struct {
    name: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    bones: [*c]spBoneDataArray = @import("std").mem.zeroes([*c]spBoneDataArray),
    ikConstraints: [*c]spIkConstraintDataArray = @import("std").mem.zeroes([*c]spIkConstraintDataArray),
    transformConstraints: [*c]spTransformConstraintDataArray = @import("std").mem.zeroes([*c]spTransformConstraintDataArray),
    pathConstraints: [*c]spPathConstraintDataArray = @import("std").mem.zeroes([*c]spPathConstraintDataArray),
    physicsConstraints: [*c]spPhysicsConstraintDataArray = @import("std").mem.zeroes([*c]spPhysicsConstraintDataArray),
    color: spColor = @import("std").mem.zeroes(spColor),
};
pub const spSkin = struct_spSkin;
pub const struct__spTimelineVtable = extern struct {
    apply: ?*const fn ([*c]spTimeline, [*c]struct_spSkeleton, f32, f32, [*c][*c]spEvent, [*c]c_int, f32, spMixBlend, spMixDirection) callconv(.c) void = @import("std").mem.zeroes(?*const fn ([*c]spTimeline, [*c]struct_spSkeleton, f32, f32, [*c][*c]spEvent, [*c]c_int, f32, spMixBlend, spMixDirection) callconv(.c) void),
    dispose: ?*const fn ([*c]spTimeline) callconv(.c) void = @import("std").mem.zeroes(?*const fn ([*c]spTimeline) callconv(.c) void),
    setBezier: ?*const fn ([*c]spTimeline, c_int, c_int, f32, f32, f32, f32, f32, f32, f32, f32, f32) callconv(.c) void = @import("std").mem.zeroes(?*const fn ([*c]spTimeline, c_int, c_int, f32, f32, f32, f32, f32, f32, f32, f32, f32) callconv(.c) void),
};
pub const _spTimelineVtable = struct__spTimelineVtable;
pub const spPropertyId = u64;
pub const struct_spTimeline = extern struct {
    vtable: _spTimelineVtable = @import("std").mem.zeroes(_spTimelineVtable),
    propertyIds: [3]spPropertyId = @import("std").mem.zeroes([3]spPropertyId),
    propertyIdsCount: c_int = @import("std").mem.zeroes(c_int),
    frames: [*c]spFloatArray = @import("std").mem.zeroes([*c]spFloatArray),
    frameCount: c_int = @import("std").mem.zeroes(c_int),
    frameEntries: c_int = @import("std").mem.zeroes(c_int),
    type: spTimelineType = @import("std").mem.zeroes(spTimelineType),
};
pub const spTimeline = struct_spTimeline;
pub const struct_spTimelineArray = extern struct {
    size: c_int = @import("std").mem.zeroes(c_int),
    capacity: c_int = @import("std").mem.zeroes(c_int),
    items: [*c][*c]spTimeline = @import("std").mem.zeroes([*c][*c]spTimeline),
};
pub const spTimelineArray = struct_spTimelineArray;
pub const struct_spPropertyIdArray = extern struct {
    size: c_int = @import("std").mem.zeroes(c_int),
    capacity: c_int = @import("std").mem.zeroes(c_int),
    items: [*c]spPropertyId = @import("std").mem.zeroes([*c]spPropertyId),
};
pub const spPropertyIdArray = struct_spPropertyIdArray;
pub const struct_spAnimation = extern struct {
    name: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    duration: f32 = @import("std").mem.zeroes(f32),
    timelines: [*c]spTimelineArray = @import("std").mem.zeroes([*c]spTimelineArray),
    timelineIds: [*c]spPropertyIdArray = @import("std").mem.zeroes([*c]spPropertyIdArray),
};
pub const spAnimation = struct_spAnimation;
pub const struct_spSkeletonData = extern struct {
    version: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    hash: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    x: f32 = @import("std").mem.zeroes(f32),
    y: f32 = @import("std").mem.zeroes(f32),
    width: f32 = @import("std").mem.zeroes(f32),
    height: f32 = @import("std").mem.zeroes(f32),
    referenceScale: f32 = @import("std").mem.zeroes(f32),
    fps: f32 = @import("std").mem.zeroes(f32),
    imagesPath: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    audioPath: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    stringsCount: c_int = @import("std").mem.zeroes(c_int),
    strings: [*c][*c]u8 = @import("std").mem.zeroes([*c][*c]u8),
    bonesCount: c_int = @import("std").mem.zeroes(c_int),
    bones: [*c][*c]spBoneData = @import("std").mem.zeroes([*c][*c]spBoneData),
    slotsCount: c_int = @import("std").mem.zeroes(c_int),
    slots: [*c][*c]spSlotData = @import("std").mem.zeroes([*c][*c]spSlotData),
    skinsCount: c_int = @import("std").mem.zeroes(c_int),
    skins: [*c][*c]spSkin = @import("std").mem.zeroes([*c][*c]spSkin),
    defaultSkin: [*c]spSkin = @import("std").mem.zeroes([*c]spSkin),
    eventsCount: c_int = @import("std").mem.zeroes(c_int),
    events: [*c][*c]spEventData = @import("std").mem.zeroes([*c][*c]spEventData),
    animationsCount: c_int = @import("std").mem.zeroes(c_int),
    animations: [*c][*c]spAnimation = @import("std").mem.zeroes([*c][*c]spAnimation),
    ikConstraintsCount: c_int = @import("std").mem.zeroes(c_int),
    ikConstraints: [*c][*c]spIkConstraintData = @import("std").mem.zeroes([*c][*c]spIkConstraintData),
    transformConstraintsCount: c_int = @import("std").mem.zeroes(c_int),
    transformConstraints: [*c][*c]spTransformConstraintData = @import("std").mem.zeroes([*c][*c]spTransformConstraintData),
    pathConstraintsCount: c_int = @import("std").mem.zeroes(c_int),
    pathConstraints: [*c][*c]spPathConstraintData = @import("std").mem.zeroes([*c][*c]spPathConstraintData),
    physicsConstraintsCount: c_int = @import("std").mem.zeroes(c_int),
    physicsConstraints: [*c][*c]spPhysicsConstraintData = @import("std").mem.zeroes([*c][*c]spPhysicsConstraintData),
};
pub const spSkeletonData = struct_spSkeletonData;
pub const struct_spBone = extern struct {
    data: [*c]spBoneData = @import("std").mem.zeroes([*c]spBoneData),
    skeleton: [*c]struct_spSkeleton = @import("std").mem.zeroes([*c]struct_spSkeleton),
    parent: [*c]spBone = @import("std").mem.zeroes([*c]spBone),
    childrenCount: c_int = @import("std").mem.zeroes(c_int),
    children: [*c][*c]spBone = @import("std").mem.zeroes([*c][*c]spBone),
    x: f32 = @import("std").mem.zeroes(f32),
    y: f32 = @import("std").mem.zeroes(f32),
    rotation: f32 = @import("std").mem.zeroes(f32),
    scaleX: f32 = @import("std").mem.zeroes(f32),
    ...
    shearX: f32 = @import("std").mem.zeroes(f32),
    shearY: f32 = @import("std").mem.zeroes(f32),
    ax: f32 = @import("std").mem.zeroes(f32),
    ay: f32 = @import("std").mem.zeroes(f32),
    arotation: f32 = @import("std").mem.zeroes(f32),
    ascaleX: f32 = @import("std").mem.zeroes(f32),
    ascaleY: f32 = @import("std").mem.zeroes(f32),
    ashearX: f32 = @import("std").mem.zeroes(f32),
    ashearY: f32 = @import("std").mem.zeroes(f32),
    a: f32 = @import("std").mem.zeroes(f32),
    b: f32 = @import("std").mem.zeroes(f32),
    worldX: f32 = @import("std").mem.zeroes(f32),
    c: f32 = @import("std").mem.zeroes(f32),
    d: f32 = @import("std").mem.zeroes(f32),
    worldY: f32 = @import("std").mem.zeroes(f32),
    sorted: c_int = @import("std").mem.zeroes(c_int),
    active: c_int = @import("std").mem.zeroes(c_int),
    inherit: spInherit = @import("std").mem.zeroes(spInherit),
};
pub const spBone = struct_spBone;
pub const struct_spSlot = extern struct {
    data: [*c]spSlotData = @import("std").mem.zeroes([*c]spSlotData),
    bone: [*c]spBone = @import("std").mem.zeroes([*c]spBone),
    color: spColor = @import("std").mem.zeroes(spColor),
    darkColor: [*c]spColor = @import("std").mem.zeroes([*c]spColor),
    attachment: [*c]spAttachment = @import("std").mem.zeroes([*c]spAttachment),
    attachmentState: c_int = @import("std").mem.zeroes(c_int),
    deformCapacity: c_int = @import("std").mem.zeroes(c_int),
    deformCount: c_int = @import("std").mem.zeroes(c_int),
    deform: [*c]f32 = @import("std").mem.zeroes([*c]f32),
    sequenceIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spSlot = struct_spSlot;
pub const struct_spIkConstraint = extern struct {
    data: [*c]spIkConstraintData = @import("std").mem.zeroes([*c]spIkConstraintData),
    bonesCount: c_int = @import("std").mem.zeroes(c_int),
    bones: [*c][*c]spBone = @import("std").mem.zeroes([*c][*c]spBone),
    target: [*c]spBone = @import("std").mem.zeroes([*c]spBone),
    bendDirection: c_int = @import("std").mem.zeroes(c_int),
    compress: c_int = @import("std").mem.zeroes(c_int),
    stretch: c_int = @import("std").mem.zeroes(c_int),
    mix: f32 = @import("std").mem.zeroes(f32),
...
pub const spIkConstraint = struct_spIkConstraint;
pub const struct_spTransformConstraint = extern struct {
    data: [*c]spTransformConstraintData = @import("std").mem.zeroes([*c]spTransformConstraintData),
    bonesCount: c_int = @import("std").mem.zeroes(c_int),
    bones: [*c][*c]spBone = @import("std").mem.zeroes([*c][*c]spBone),
    target: [*c]spBone = @import("std").mem.zeroes([*c]spBone),
    mixRotate: f32 = @import("std").mem.zeroes(f32),
...
pub const spTransformConstraint = struct_spTransformConstraint;
pub const struct_spPathConstraint = extern struct {
    data: [*c]spPathConstraintData = @import("std").mem.zeroes([*c]spPathConstraintData),
    bonesCount: c_int = @import("std").mem.zeroes(c_int),
    bones: [*c][*c]spBone = @import("std").mem.zeroes([*c][*c]spBone),
    target: [*c]spSlot = @import("std").mem.zeroes([*c]spSlot),
    position: f32 = @import("std").mem.zeroes(f32),
    spacing: f32 = @import("std").mem.zeroes(f32),
    mixRotate: f32 = @import("std").mem.zeroes(f32),
    mixX: f32 = @import("std").mem.zeroes(f32),
    mixY: f32 = @import("std").mem.zeroes(f32),
    spacesCount: c_int = @import("std").mem.zeroes(c_int),
    spaces: [*c]f32 = @import("std").mem.zeroes([*c]f32),
    positionsCount: c_int = @import("std").mem.zeroes(c_int),
    positions: [*c]f32 = @import("std").mem.zeroes([*c]f32),
    worldCount: c_int = @import("std").mem.zeroes(c_int),
    world: [*c]f32 = @import("std").mem.zeroes([*c]f32),
    curvesCount: c_int = @import("std").mem.zeroes(c_int),
    curves: [*c]f32 = @import("std").mem.zeroes([*c]f32),
    lengthsCount: c_int = @import("std").mem.zeroes(c_int),
    lengths: [*c]f32 = @import("std").mem.zeroes([*c]f32),
    segments: [10]f32 = @import("std").mem.zeroes([10]f32),
    active: c_int = @import("std").mem.zeroes(c_int),
};
pub const spPathConstraint = struct_spPathConstraint;
pub const struct_spPhysicsConstraint = extern struct {
    data: [*c]spPhysicsConstraintData = @import("std").mem.zeroes([*c]spPhysicsConstraintData),
    bone: [*c]spBone = @import("std").mem.zeroes([*c]spBone),
    inertia: f32 = @import("std").mem.zeroes(f32),
    strength: f32 = @import("std").mem.zeroes(f32),
    damping: f32 = @import("std").mem.zeroes(f32),
    ...
    gravity: f32 = @import("std").mem.zeroes(f32),
    mix: f32 = @import("std").mem.zeroes(f32),
    reset: c_int = @import("std").mem.zeroes(c_int),
    ux: f32 = @import("std").mem.zeroes(f32),
    uy: f32 = @import("std").mem.zeroes(f32),
    cx: f32 = @import("std").mem.zeroes(f32),
    cy: f32 = @import("std").mem.zeroes(f32),
    tx: f32 = @import("std").mem.zeroes(f32),
    ty: f32 = @import("std").mem.zeroes(f32),
    xOffset: f32 = @import("std").mem.zeroes(f32),
    xVelocity: f32 = @import("std").mem.zeroes(f32),
    yOffset: f32 = @import("std").mem.zeroes(f32),
    yVelocity: f32 = @import("std").mem.zeroes(f32),
    rotateOffset: f32 = @import("std").mem.zeroes(f32),
    rotateVelocity: f32 = @import("std").mem.zeroes(f32),
    scaleOffset: f32 = @import("std").mem.zeroes(f32),
    scaleVelocity: f32 = @import("std").mem.zeroes(f32),
    active: c_int = @import("std").mem.zeroes(c_int),
    skeleton: [*c]struct_spSkeleton = @import("std").mem.zeroes([*c]struct_spSkeleton),
    remaining: f32 = @import("std").mem.zeroes(f32),
    lastTime: f32 = @import("std").mem.zeroes(f32),
};
pub const spPhysicsConstraint = struct_spPhysicsConstraint;
pub const struct_spSkeleton = extern struct {
    data: [*c]spSkeletonData = @import("std").mem.zeroes([*c]spSkeletonData),
    bonesCount: c_int = @import("std").mem.zeroes(c_int),
    bones: [*c][*c]spBone = @import("std").mem.zeroes([*c][*c]spBone),
    root: [*c]spBone = @import("std").mem.zeroes([*c]spBone),
    slotsCount: c_int = @import("std").mem.zeroes(c_int),
    slots: [*c][*c]spSlot = @import("std").mem.zeroes([*c][*c]spSlot),
    drawOrder: [*c][*c]spSlot = @import("std").mem.zeroes([*c][*c]spSlot),
    ikConstraintsCount: c_int = @import("std").mem.zeroes(c_int),
    ikConstraints: [*c][*c]spIkConstraint = @import("std").mem.zeroes([*c][*c]spIkConstraint),
    transformConstraintsCount: c_int = @import("std").mem.zeroes(c_int),
    transformConstraints: [*c][*c]spTransformConstraint = @import("std").mem.zeroes([*c][*c]spTransformConstraint),
    pathConstraintsCount: c_int = @import("std").mem.zeroes(c_int),
    pathConstraints: [*c][*c]spPathConstraint = @import("std").mem.zeroes([*c][*c]spPathConstraint),
    physicsConstraintsCount: c_int = @import("std").mem.zeroes(c_int),
    physicsConstraints: [*c][*c]spPhysicsConstraint = @import("std").mem.zeroes([*c][*c]spPhysicsConstraint),
    skin: [*c]spSkin = @import("std").mem.zeroes([*c]spSkin),
    color: spColor = @import("std").mem.zeroes(spColor),
    scaleX: f32 = @import("std").mem.zeroes(f32),
    scaleY: f32 = @import("std").mem.zeroes(f32),
    x: f32 = @import("std").mem.zeroes(f32),
...
pub extern fn spBone_setYDown(yDown: c_int) void;
pub extern fn spBone_isYDown() c_int;
pub extern fn spBone_create(data: [*c]spBoneData, skeleton: [*c]struct_spSkeleton, parent: [*c]spBone) [*c]spBone;
pub extern fn spBone_dispose(self: [*c]spBone) void;
pub extern fn spBone_setToSetupPose(self: [*c]spBone) void;
pub extern fn spBone_update(self: [*c]spBone) void;
pub extern fn spBone_updateWorldTransform(self: [*c]spBone) void;
pub extern fn spBone_updateWorldTransformWith(self: [*c]spBone, x: f32, y: f32, rotation: f32, scaleX: f32, scaleY: f32, shearX: f32, shearY: f32) void;
pub extern fn spBone_getWorldRotationX(self: [*c]spBone) f32;
pub extern fn spBone_getWorldRotationY(self: [*c]spBone) f32;
pub extern fn spBone_getWorldScaleX(self: [*c]spBone) f32;
pub extern fn spBone_getWorldScaleY(self: [*c]spBone) f32;
pub extern fn spBone_updateAppliedTransform(self: [*c]spBone) void;
pub extern fn spBone_worldToLocal(self: [*c]spBone, worldX: f32, worldY: f32, localX: [*c]f32, localY: [*c]f32) void;
pub extern fn spBone_worldToParent(self: [*c]spBone, worldX: f32, worldY: f32, parentX: [*c]f32, parentY: [*c]f32) void;
pub extern fn spBone_localToWorld(self: [*c]spBone, localX: f32, localY: f32, worldX: [*c]f32, worldY: [*c]f32) void;
pub extern fn spBone_localToParent(self: [*c]spBone, localX: f32, localY: f32, parentX: [*c]f32, parentY: [*c]f32) void;
pub extern fn spBone_worldToLocalRotation(self: [*c]spBone, worldRotation: f32) f32;
pub extern fn spBone_localToWorldRotation(self: [*c]spBone, localRotation: f32) f32;
pub extern fn spBone_rotateWorld(self: [*c]spBone, degrees: f32) void;
pub const SP_BLEND_MODE_NORMAL: c_int = 0;
pub const SP_BLEND_MODE_ADDITIVE: c_int = 1;
pub const SP_BLEND_MODE_MULTIPLY: c_int = 2;
pub const SP_BLEND_MODE_SCREEN: c_int = 3;
pub const spBlendMode = c_uint;
pub extern fn spSlotData_create(index: c_int, name: [*c]const u8, boneData: [*c]spBoneData) [*c]spSlotData;
pub extern fn spSlotData_dispose(self: [*c]spSlotData) void;
pub extern fn spSlotData_setAttachmentName(self: [*c]spSlotData, attachmentName: [*c]const u8) void;
pub extern fn spSlot_create(data: [*c]spSlotData, bone: [*c]spBone) [*c]spSlot;
pub extern fn spSlot_dispose(self: [*c]spSlot) void;
pub extern fn spSlot_setAttachment(self: [*c]spSlot, attachment: [*c]spAttachment) void;
pub extern fn spSlot_setToSetupPose(self: [*c]spSlot) void;
pub const struct_spVertexAttachment = extern struct {
    super: spAttachment = @import("std").mem.zeroes(spAttachment),
    bonesCount: c_int = @import("std").mem.zeroes(c_int),
    bones: [*c]c_int = @import("std").mem.zeroes([*c]c_int),
    verticesCount: c_int = @import("std").mem.zeroes(c_int),
    vertices: [*c]f32 = @import("std").mem.zeroes([*c]f32),
    worldVerticesLength: c_int = @import("std").mem.zeroes(c_int),
    timelineAttachment: [*c]spAttachment = @import("std").mem.zeroes([*c]spAttachment),
    id: c_int = @import("std").mem.zeroes(c_int),
};
pub const spVertexAttachment = struct_spVertexAttachment;
pub extern fn spVertexAttachment_computeWorldVertices(self: [*c]spVertexAttachment, slot: [*c]spSlot, start: c_int, count: c_int, worldVertices: [*c]f32, offset: c_int, stride: c_int) void;
pub extern fn spVertexAttachment_copyTo(self: [*c]spVertexAttachment, other: [*c]spVertexAttachment) void;
pub const struct_spTextureRegion = extern struct {
    rendererObject: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    u: f32 = @import("std").mem.zeroes(f32),
    v: f32 = @import("std").mem.zeroes(f32),
    u2: f32 = @import("std").mem.zeroes(f32),
    v2: f32 = @import("std").mem.zeroes(f32),
    degrees: c_int = @import("std").mem.zeroes(c_int),
    offsetX: f32 = @import("std").mem.zeroes(f32),
    offsetY: f32 = @import("std").mem.zeroes(f32),
    width: c_int = @import("std").mem.zeroes(c_int),
    height: c_int = @import("std").mem.zeroes(c_int),
    originalWidth: c_int = @import("std").mem.zeroes(c_int),
    originalHeight: c_int = @import("std").mem.zeroes(c_int),
};
pub const spTextureRegion = struct_spTextureRegion;
pub const spAtlas = struct_spAtlas;
pub const struct_spAtlasPage = extern struct {
    atlas: [*c]spAtlas = @import("std").mem.zeroes([*c]spAtlas),
    name: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    format: spAtlasFormat = @import("std").mem.zeroes(spAtlasFormat),
    minFilter: spAtlasFilter = @import("std").mem.zeroes(spAtlasFilter),
    magFilter: spAtlasFilter = @import("std").mem.zeroes(spAtlasFilter),
    uWrap: spAtlasWrap = @import("std").mem.zeroes(spAtlasWrap),
    vWrap: spAtlasWrap = @import("std").mem.zeroes(spAtlasWrap),
    rendererObject: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    width: c_int = @import("std").mem.zeroes(c_int),
    height: c_int = @import("std").mem.zeroes(c_int),
    pma: c_int = @import("std").mem.zeroes(c_int),
    next: [*c]spAtlasPage = @import("std").mem.zeroes([*c]spAtlasPage),
};
pub const spAtlasPage = struct_spAtlasPage;
pub const struct_spKeyValue = extern struct {
    name: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    values: [5]f32 = @import("std").mem.zeroes([5]f32),
};
pub const spKeyValue = struct_spKeyValue;
pub const struct_spKeyValueArray = extern struct {
    size: c_int = @import("std").mem.zeroes(c_int),
    capacity: c_int = @import("std").mem.zeroes(c_int),
    items: [*c]spKeyValue = @import("std").mem.zeroes([*c]spKeyValue),
};
pub const spKeyValueArray = struct_spKeyValueArray;
pub const struct_spAtlasRegion = extern struct {
    super: spTextureRegion = @import("std").mem.zeroes(spTextureRegion),
    name: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    x: c_int = @import("std").mem.zeroes(c_int),
    y: c_int = @import("std").mem.zeroes(c_int),
    index: c_int = @import("std").mem.zeroes(c_int),
    splits: [*c]c_int = @import("std").mem.zeroes([*c]c_int),
    pads: [*c]c_int = @import("std").mem.zeroes([*c]c_int),
    keyValues: [*c]spKeyValueArray = @import("std").mem.zeroes([*c]spKeyValueArray),
    page: [*c]spAtlasPage = @import("std").mem.zeroes([*c]spAtlasPage),
    next: [*c]spAtlasRegion = @import("std").mem.zeroes([*c]spAtlasRegion),
};
pub const spAtlasRegion = struct_spAtlasRegion;
pub const struct_spAtlas = extern struct {
    pages: [*c]spAtlasPage = @import("std").mem.zeroes([*c]spAtlasPage),
    regions: [*c]spAtlasRegion = @import("std").mem.zeroes([*c]spAtlasRegion),
    rendererObject: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
pub const SP_ATLAS_UNKNOWN_FORMAT: c_int = 0;
pub const SP_ATLAS_ALPHA: c_int = 1;
pub const SP_ATLAS_INTENSITY: c_int = 2;
pub const SP_ATLAS_LUMINANCE_ALPHA: c_int = 3;
pub const SP_ATLAS_RGB565: c_int = 4;
pub const SP_ATLAS_RGBA4444: c_int = 5;
pub const SP_ATLAS_RGB888: c_int = 6;
pub const SP_ATLAS_RGBA8888: c_int = 7;
pub const spAtlasFormat = c_uint;
pub const SP_ATLAS_UNKNOWN_FILTER: c_int = 0;
pub const SP_ATLAS_NEAREST: c_int = 1;
pub const SP_ATLAS_LINEAR: c_int = 2;
pub const SP_ATLAS_MIPMAP: c_int = 3;
pub const SP_ATLAS_MIPMAP_NEAREST_NEAREST: c_int = 4;
pub const SP_ATLAS_MIPMAP_LINEAR_NEAREST: c_int = 5;
pub const SP_ATLAS_MIPMAP_NEAREST_LINEAR: c_int = 6;
pub const SP_ATLAS_MIPMAP_LINEAR_LINEAR: c_int = 7;
pub const spAtlasFilter = c_uint;
pub const SP_ATLAS_MIRROREDREPEAT: c_int = 0;
pub const SP_ATLAS_CLAMPTOEDGE: c_int = 1;
pub const SP_ATLAS_REPEAT: c_int = 2;
pub const spAtlasWrap = c_uint;
pub extern fn spAtlasPage_create(atlas: [*c]spAtlas, name: [*c]const u8) [*c]spAtlasPage;
pub extern fn spAtlasPage_dispose(self: [*c]spAtlasPage) void;
pub extern fn spKeyValueArray_create(initialCapacity: c_int) [*c]spKeyValueArray;
pub extern fn spKeyValueArray_dispose(self: [*c]spKeyValueArray) void;
pub extern fn spKeyValueArray_clear(self: [*c]spKeyValueArray) void;
pub extern fn spKeyValueArray_setSize(self: [*c]spKeyValueArray, newSize: c_int) [*c]spKeyValueArray;
pub extern fn spKeyValueArray_ensureCapacity(self: [*c]spKeyValueArray, newCapacity: c_int) void;
pub extern fn spKeyValueArray_add(self: [*c]spKeyValueArray, value: spKeyValue) void;
pub extern fn spKeyValueArray_addAll(self: [*c]spKeyValueArray, other: [*c]spKeyValueArray) void;
pub extern fn spKeyValueArray_addAllValues(self: [*c]spKeyValueArray, values: [*c]spKeyValue, offset: c_int, count: c_int) void;
pub extern fn spKeyValueArray_removeAt(self: [*c]spKeyValueArray, index: c_int) void;
pub extern fn spKeyValueArray_contains(self: [*c]spKeyValueArray, value: spKeyValue) c_int;
pub extern fn spKeyValueArray_pop(self: [*c]spKeyValueArray) spKeyValue;
pub extern fn spKeyValueArray_peek(self: [*c]spKeyValueArray) spKeyValue;
pub extern fn spAtlasRegion_create() [*c]spAtlasRegion;
pub extern fn spAtlasRegion_dispose(self: [*c]spAtlasRegion) void;
pub extern fn spAtlas_create(data: [*c]const u8, length: c_int, dir: [*c]const u8, rendererObject: ?*anyopaque) [*c]spAtlas;
pub extern fn spAtlas_createFromFile(path: [*c]const u8, rendererObject: ?*anyopaque) [*c]spAtlas;
pub extern fn spAtlas_dispose(atlas: [*c]spAtlas) void;
pub extern fn spAtlas_findRegion(self: [*c]const spAtlas, name: [*c]const u8) [*c]spAtlasRegion;
pub const struct_spTextureRegionArray = extern struct {
    size: c_int = @import("std").mem.zeroes(c_int),
    capacity: c_int = @import("std").mem.zeroes(c_int),
    items: [*c][*c]spTextureRegion = @import("std").mem.zeroes([*c][*c]spTextureRegion),
};
pub const spTextureRegionArray = struct_spTextureRegionArray;
pub extern fn spTextureRegionArray_create(initialCapacity: c_int) [*c]spTextureRegionArray;
pub extern fn spTextureRegionArray_dispose(self: [*c]spTextureRegionArray) void;
pub extern fn spTextureRegionArray_clear(self: [*c]spTextureRegionArray) void;
pub extern fn spTextureRegionArray_setSize(self: [*c]spTextureRegionArray, newSize: c_int) [*c]spTextureRegionArray;
pub extern fn spTextureRegionArray_ensureCapacity(self: [*c]spTextureRegionArray, newCapacity: c_int) void;
pub extern fn spTextureRegionArray_add(self: [*c]spTextureRegionArray, value: [*c]spTextureRegion) void;
pub extern fn spTextureRegionArray_addAll(self: [*c]spTextureRegionArray, other: [*c]spTextureRegionArray) void;
pub extern fn spTextureRegionArray_addAllValues(self: [*c]spTextureRegionArray, values: [*c][*c]spTextureRegion, offset: c_int, count: c_int) void;
pub extern fn spTextureRegionArray_removeAt(self: [*c]spTextureRegionArray, index: c_int) void;
pub extern fn spTextureRegionArray_contains(self: [*c]spTextureRegionArray, value: [*c]spTextureRegion) c_int;
pub extern fn spTextureRegionArray_pop(self: [*c]spTextureRegionArray) [*c]spTextureRegion;
pub extern fn spTextureRegionArray_peek(self: [*c]spTextureRegionArray) [*c]spTextureRegion;
pub const struct_spSequence = extern struct {
    id: c_int = @import("std").mem.zeroes(c_int),
    start: c_int = @import("std").mem.zeroes(c_int),
    digits: c_int = @import("std").mem.zeroes(c_int),
    setupIndex: c_int = @import("std").mem.zeroes(c_int),
    regions: [*c]spTextureRegionArray = @import("std").mem.zeroes([*c]spTextureRegionArray),
};
pub const spSequence = struct_spSequence;
pub extern fn spSequence_create(numRegions: c_int) [*c]spSequence;
pub extern fn spSequence_dispose(self: [*c]spSequence) void;
pub extern fn spSequence_copy(self: [*c]spSequence) [*c]spSequence;
pub extern fn spSequence_apply(self: [*c]spSequence, slot: [*c]spSlot, attachment: [*c]spAttachment) void;
pub extern fn spSequence_getPath(self: [*c]spSequence, basePath: [*c]const u8, index: c_int, path: [*c]u8) void;
...
pub extern fn spPropertyIdArray_create(initialCapacity: c_int) [*c]spPropertyIdArray;
pub extern fn spPropertyIdArray_dispose(self: [*c]spPropertyIdArray) void;
pub extern fn spPropertyIdArray_clear(self: [*c]spPropertyIdArray) void;
pub extern fn spPropertyIdArray_setSize(self: [*c]spPropertyIdArray, newSize: c_int) [*c]spPropertyIdArray;
pub extern fn spPropertyIdArray_ensureCapacity(self: [*c]spPropertyIdArray, newCapacity: c_int) void;
pub extern fn spPropertyIdArray_add(self: [*c]spPropertyIdArray, value: spPropertyId) void;
pub extern fn spPropertyIdArray_addAll(self: [*c]spPropertyIdArray, other: [*c]spPropertyIdArray) void;
pub extern fn spPropertyIdArray_addAllValues(self: [*c]spPropertyIdArray, values: [*c]spPropertyId, offset: c_int, count: c_int) void;
pub extern fn spPropertyIdArray_removeAt(self: [*c]spPropertyIdArray, index: c_int) void;
pub extern fn spPropertyIdArray_contains(self: [*c]spPropertyIdArray, value: spPropertyId) c_int;
pub extern fn spPropertyIdArray_pop(self: [*c]spPropertyIdArray) spPropertyId;
pub extern fn spPropertyIdArray_peek(self: [*c]spPropertyIdArray) spPropertyId;
pub extern fn spTimelineArray_create(initialCapacity: c_int) [*c]spTimelineArray;
pub extern fn spTimelineArray_dispose(self: [*c]spTimelineArray) void;
pub extern fn spTimelineArray_clear(self: [*c]spTimelineArray) void;
pub extern fn spTimelineArray_setSize(self: [*c]spTimelineArray, newSize: c_int) [*c]spTimelineArray;
pub extern fn spTimelineArray_ensureCapacity(self: [*c]spTimelineArray, newCapacity: c_int) void;
pub extern fn spTimelineArray_add(self: [*c]spTimelineArray, value: [*c]spTimeline) void;
pub extern fn spTimelineArray_addAll(self: [*c]spTimelineArray, other: [*c]spTimelineArray) void;
pub extern fn spTimelineArray_addAllValues(self: [*c]spTimelineArray, values: [*c][*c]spTimeline, offset: c_int, count: c_int) void;
pub extern fn spTimelineArray_removeAt(self: [*c]spTimelineArray, index: c_int) void;
pub extern fn spTimelineArray_contains(self: [*c]spTimelineArray, value: [*c]spTimeline) c_int;
pub extern fn spTimelineArray_pop(self: [*c]spTimelineArray) [*c]spTimeline;
pub extern fn spTimelineArray_peek(self: [*c]spTimelineArray) [*c]spTimeline;
pub const SP_MIX_BLEND_SETUP: c_int = 0;
pub const SP_MIX_BLEND_FIRST: c_int = 1;
pub const SP_MIX_BLEND_REPLACE: c_int = 2;
pub const SP_MIX_BLEND_ADD: c_int = 3;
pub const spMixBlend = c_uint;
pub const SP_MIX_DIRECTION_IN: c_int = 0;
pub const SP_MIX_DIRECTION_OUT: c_int = 1;
pub const spMixDirection = c_uint;
pub extern fn spAnimation_create(name: [*c]const u8, timelines: [*c]spTimelineArray, duration: f32) [*c]spAnimation;
pub extern fn spAnimation_dispose(self: [*c]spAnimation) void;
pub extern fn spAnimation_hasTimeline(self: [*c]spAnimation, ids: [*c]spPropertyId, idsCount: c_int) c_int;
pub extern fn spAnimation_apply(self: [*c]const spAnimation, skeleton: [*c]struct_spSkeleton, lastTime: f32, time: f32, loop: c_int, events: [*c][*c]spEvent, eventsCount: [*c]c_int, alpha: f32, blend: spMixBlend, direction: spMixDirection) void;
pub const SP_TIMELINE_ATTACHMENT: c_int = 0;
pub const SP_TIMELINE_ALPHA: c_int = 1;
pub const SP_TIMELINE_PATHCONSTRAINTPOSITION: c_int = 2;
pub const SP_TIMELINE_PATHCONSTRAINTSPACING: c_int = 3;
pub const SP_TIMELINE_ROTATE: c_int = 4;
pub const SP_TIMELINE_SCALEX: c_int = 5;
pub const SP_TIMELINE_SCALEY: c_int = 6;
pub const SP_TIMELINE_SHEARX: c_int = 7;
pub const SP_TIMELINE_SHEARY: c_int = 8;
pub const SP_TIMELINE_TRANSLATEX: c_int = 9;
pub const SP_TIMELINE_TRANSLATEY: c_int = 10;
pub const SP_TIMELINE_SCALE: c_int = 11;
pub const SP_TIMELINE_SHEAR: c_int = 12;
pub const SP_TIMELINE_TRANSLATE: c_int = 13;
pub const SP_TIMELINE_DEFORM: c_int = 14;
pub const SP_TIMELINE_SEQUENCE: c_int = 15;
pub const SP_TIMELINE_INHERIT: c_int = 16;
pub const SP_TIMELINE_IKCONSTRAINT: c_int = 17;
pub const SP_TIMELINE_PATHCONSTRAINTMIX: c_int = 18;
pub const SP_TIMELINE_PHYSICSCONSTRAINT_INERTIA: c_int = 19;
pub const SP_TIMELINE_PHYSICSCONSTRAINT_STRENGTH: c_int = 20;
pub const SP_TIMELINE_PHYSICSCONSTRAINT_DAMPING: c_int = 21;
pub const SP_TIMELINE_PHYSICSCONSTRAINT_MASS: c_int = 22;
pub const SP_TIMELINE_PHYSICSCONSTRAINT_WIND: c_int = 23;
pub const SP_TIMELINE_PHYSICSCONSTRAINT_GRAVITY: c_int = 24;
pub const SP_TIMELINE_PHYSICSCONSTRAINT_MIX: c_int = 25;
pub const SP_TIMELINE_PHYSICSCONSTRAINT_RESET: c_int = 26;
pub const SP_TIMELINE_RGB2: c_int = 27;
pub const SP_TIMELINE_RGBA2: c_int = 28;
pub const SP_TIMELINE_RGBA: c_int = 29;
pub const SP_TIMELINE_RGB: c_int = 30;
pub const SP_TIMELINE_TRANSFORMCONSTRAINT: c_int = 31;
pub const SP_TIMELINE_DRAWORDER: c_int = 32;
pub const SP_TIMELINE_EVENT: c_int = 33;
pub const spTimelineType = c_uint;
pub const SP_PROPERTY_ROTATE: c_int = 1;
pub const SP_PROPERTY_X: c_int = 2;
pub const SP_PROPERTY_Y: c_int = 4;
pub const SP_PROPERTY_SCALEX: c_int = 8;
pub const SP_PROPERTY_SCALEY: c_int = 16;
pub const SP_PROPERTY_SHEARX: c_int = 32;
pub const SP_PROPERTY_SHEARY: c_int = 64;
pub const SP_PROPERTY_INHERIT: c_int = 128;
pub const SP_PROPERTY_RGB: c_int = 256;
pub const SP_PROPERTY_ALPHA: c_int = 512;
pub const SP_PROPERTY_RGB2: c_int = 1024;
pub const SP_PROPERTY_ATTACHMENT: c_int = 2048;
pub const SP_PROPERTY_DEFORM: c_int = 4096;
pub const SP_PROPERTY_EVENT: c_int = 8192;
pub const SP_PROPERTY_DRAWORDER: c_int = 16384;
pub const SP_PROPERTY_IKCONSTRAINT: c_int = 32768;
pub const SP_PROPERTY_TRANSFORMCONSTRAINT: c_int = 65536;
pub const SP_PROPERTY_PATHCONSTRAINT_POSITION: c_int = 131072;
pub const SP_PROPERTY_PATHCONSTRAINT_SPACING: c_int = 262144;
pub const SP_PROPERTY_PATHCONSTRAINT_MIX: c_int = 524288;
pub const SP_PROPERTY_PHYSICSCONSTRAINT_INERTIA: c_int = 1048576;
pub const SP_PROPERTY_PHYSICSCONSTRAINT_STRENGTH: c_int = 2097152;
pub const SP_PROPERTY_PHYSICSCONSTRAINT_DAMPING: c_int = 4194304;
pub const SP_PROPERTY_PHYSICSCONSTRAINT_MASS: c_int = 8388608;
pub const SP_PROPERTY_PHYSICSCONSTRAINT_WIND: c_int = 16777216;
pub const SP_PROPERTY_PHYSICSCONSTRAINT_GRAVITY: c_int = 33554432;
pub const SP_PROPERTY_PHYSICSCONSTRAINT_MIX: c_int = 67108864;
pub const SP_PROPERTY_PHYSICSCONSTRAINT_RESET: c_int = 134217728;
pub const SP_PROPERTY_SEQUENCE: c_int = 268435456;
pub const spProperty = c_uint;
pub extern fn spTimeline_dispose(self: [*c]spTimeline) void;
pub extern fn spTimeline_apply(self: [*c]spTimeline, skeleton: [*c]struct_spSkeleton, lastTime: f32, time: f32, firedEvents: [*c][*c]spEvent, eventsCount: [*c]c_int, alpha: f32, blend: spMixBlend, direction: spMixDirection) void;
pub extern fn spTimeline_setBezier(self: [*c]spTimeline, bezier: c_int, frame: c_int, value: f32, time1: f32, value1: f32, cx1: f32, cy1: f32, cx2: f32, cy2: f32, time2: f32, value2: f32) void;
pub extern fn spTimeline_getDuration(self: [*c]const spTimeline) f32;
pub const struct_spCurveTimeline = extern struct {
    super: spTimeline = @import("std").mem.zeroes(spTimeline),
    curves: [*c]spFloatArray = @import("std").mem.zeroes([*c]spFloatArray),
};
pub const spCurveTimeline = struct_spCurveTimeline;
pub extern fn spCurveTimeline_setLinear(self: [*c]spCurveTimeline, frameIndex: c_int) void;
pub extern fn spCurveTimeline_setStepped(self: [*c]spCurveTimeline, frameIndex: c_int) void;
pub extern fn spCurveTimeline_setCurve(self: [*c]spCurveTimeline, frameIndex: c_int, cx1: f32, cy1: f32, cx2: f32, cy2: f32) void;
pub extern fn spCurveTimeline_getCurvePercent(self: [*c]const spCurveTimeline, frameIndex: c_int, percent: f32) f32;
pub const spCurveTimeline1 = struct_spCurveTimeline;
pub extern fn spCurveTimeline1_setFrame(self: [*c]spCurveTimeline1, frame: c_int, time: f32, value: f32) void;
pub extern fn spCurveTimeline1_getCurveValue(self: [*c]spCurveTimeline1, time: f32) f32;
pub extern fn spCurveTimeline1_getRelativeValue(timeline: [*c]spCurveTimeline1, time: f32, alpha: f32, blend: spMixBlend, current: f32, setup: f32) f32;
pub extern fn spCurveTimeline1_getAbsoluteValue(timeline: [*c]spCurveTimeline1, time: f32, alpha: f32, blend: spMixBlend, current: f32, setup: f32) f32;
pub extern fn spCurveTimeline1_getAbsoluteValue2(timeline: [*c]spCurveTimeline1, time: f32, alpha: f32, blend: spMixBlend, current: f32, setup: f32, value: f32) f32;
pub extern fn spCurveTimeline1_getScaleValue(timeline: [*c]spCurveTimeline1, time: f32, alpha: f32, blend: spMixBlend, direction: spMixDirection, current: f32, setup: f32) f32;
pub const spCurveTimeline2 = struct_spCurveTimeline;
pub extern fn spCurveTimeline2_setFrame(self: [*c]spCurveTimeline1, frame: c_int, time: f32, value1: f32, value2: f32) void;
pub const struct_spRotateTimeline = extern struct {
    super: spCurveTimeline1 = @import("std").mem.zeroes(spCurveTimeline1),
    boneIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spRotateTimeline = struct_spRotateTimeline;
pub extern fn spRotateTimeline_create(frameCount: c_int, bezierCount: c_int, boneIndex: c_int) [*c]spRotateTimeline;
pub extern fn spRotateTimeline_setFrame(self: [*c]spRotateTimeline, frameIndex: c_int, time: f32, angle: f32) void;
pub const struct_spTranslateTimeline = extern struct {
    super: spCurveTimeline2 = @import("std").mem.zeroes(spCurveTimeline2),
    boneIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spTranslateTimeline = struct_spTranslateTimeline;
pub extern fn spTranslateTimeline_create(frameCount: c_int, bezierCount: c_int, boneIndex: c_int) [*c]spTranslateTimeline;
pub extern fn spTranslateTimeline_setFrame(self: [*c]spTranslateTimeline, frameIndex: c_int, time: f32, x: f32, y: f32) void;
pub const struct_spTranslateXTimeline = extern struct {
    super: spCurveTimeline1 = @import("std").mem.zeroes(spCurveTimeline1),
    boneIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spTranslateXTimeline = struct_spTranslateXTimeline;
pub extern fn spTranslateXTimeline_create(frameCount: c_int, bezierCount: c_int, boneIndex: c_int) [*c]spTranslateXTimeline;
pub extern fn spTranslateXTimeline_setFrame(self: [*c]spTranslateXTimeline, frame: c_int, time: f32, x: f32) void;
pub const struct_spTranslateYTimeline = extern struct {
    super: spCurveTimeline1 = @import("std").mem.zeroes(spCurveTimeline1),
    boneIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spTranslateYTimeline = struct_spTranslateYTimeline;
pub extern fn spTranslateYTimeline_create(frameCount: c_int, bezierCount: c_int, boneIndex: c_int) [*c]spTranslateYTimeline;
pub extern fn spTranslateYTimeline_setFrame(self: [*c]spTranslateYTimeline, frame: c_int, time: f32, y: f32) void;
pub const struct_spScaleTimeline = extern struct {
    super: spCurveTimeline2 = @import("std").mem.zeroes(spCurveTimeline2),
    boneIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spScaleTimeline = struct_spScaleTimeline;
pub extern fn spScaleTimeline_create(frameCount: c_int, bezierCount: c_int, boneIndex: c_int) [*c]spScaleTimeline;
pub extern fn spScaleTimeline_setFrame(self: [*c]spScaleTimeline, frameIndex: c_int, time: f32, x: f32, y: f32) void;
pub const struct_spScaleXTimeline = extern struct {
    super: spCurveTimeline1 = @import("std").mem.zeroes(spCurveTimeline1),
    boneIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spScaleXTimeline = struct_spScaleXTimeline;
pub extern fn spScaleXTimeline_create(frameCount: c_int, bezierCount: c_int, boneIndex: c_int) [*c]spScaleXTimeline;
pub extern fn spScaleXTimeline_setFrame(self: [*c]spScaleXTimeline, frame: c_int, time: f32, x: f32) void;
pub const struct_spScaleYTimeline = extern struct {
    super: spCurveTimeline1 = @import("std").mem.zeroes(spCurveTimeline1),
    boneIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spScaleYTimeline = struct_spScaleYTimeline;
pub extern fn spScaleYTimeline_create(frameCount: c_int, bezierCount: c_int, boneIndex: c_int) [*c]spScaleYTimeline;
pub extern fn spScaleYTimeline_setFrame(self: [*c]spScaleYTimeline, frame: c_int, time: f32, y: f32) void;
pub const struct_spShearTimeline = extern struct {
    super: spCurveTimeline2 = @import("std").mem.zeroes(spCurveTimeline2),
    boneIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spShearTimeline = struct_spShearTimeline;
pub extern fn spShearTimeline_create(frameCount: c_int, bezierCount: c_int, boneIndex: c_int) [*c]spShearTimeline;
pub extern fn spShearTimeline_setFrame(self: [*c]spShearTimeline, frameIndex: c_int, time: f32, x: f32, y: f32) void;
pub const struct_spShearXTimeline = extern struct {
    super: spCurveTimeline1 = @import("std").mem.zeroes(spCurveTimeline1),
    boneIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spShearXTimeline = struct_spShearXTimeline;
pub extern fn spShearXTimeline_create(frameCount: c_int, bezierCount: c_int, boneIndex: c_int) [*c]spShearXTimeline;
pub extern fn spShearXTimeline_setFrame(self: [*c]spShearXTimeline, frame: c_int, time: f32, x: f32) void;
pub const struct_spShearYTimeline = extern struct {
    super: spCurveTimeline1 = @import("std").mem.zeroes(spCurveTimeline1),
    boneIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spShearYTimeline = struct_spShearYTimeline;
pub extern fn spShearYTimeline_create(frameCount: c_int, bezierCount: c_int, boneIndex: c_int) [*c]spShearYTimeline;
pub extern fn spShearYTimeline_setFrame(self: [*c]spShearYTimeline, frame: c_int, time: f32, x: f32) void;
pub const struct_spRGBATimeline = extern struct {
    super: spCurveTimeline2 = @import("std").mem.zeroes(spCurveTimeline2),
    slotIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spRGBATimeline = struct_spRGBATimeline;
pub extern fn spRGBATimeline_create(framesCount: c_int, bezierCount: c_int, slotIndex: c_int) [*c]spRGBATimeline;
pub extern fn spRGBATimeline_setFrame(self: [*c]spRGBATimeline, frameIndex: c_int, time: f32, r: f32, g: f32, b: f32, a: f32) void;
pub const struct_spRGBTimeline = extern struct {
    super: spCurveTimeline2 = @import("std").mem.zeroes(spCurveTimeline2),
    slotIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spRGBTimeline = struct_spRGBTimeline;
pub extern fn spRGBTimeline_create(framesCount: c_int, bezierCount: c_int, slotIndex: c_int) [*c]spRGBTimeline;
pub extern fn spRGBTimeline_setFrame(self: [*c]spRGBTimeline, frameIndex: c_int, time: f32, r: f32, g: f32, b: f32) void;
pub const struct_spAlphaTimeline = extern struct {
    super: spCurveTimeline1 = @import("std").mem.zeroes(spCurveTimeline1),
    slotIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spAlphaTimeline = struct_spAlphaTimeline;
pub extern fn spAlphaTimeline_create(frameCount: c_int, bezierCount: c_int, slotIndex: c_int) [*c]spAlphaTimeline;
pub extern fn spAlphaTimeline_setFrame(self: [*c]spAlphaTimeline, frame: c_int, time: f32, x: f32) void;
pub const struct_spRGBA2Timeline = extern struct {
    super: spCurveTimeline = @import("std").mem.zeroes(spCurveTimeline),
    slotIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spRGBA2Timeline = struct_spRGBA2Timeline;
pub extern fn spRGBA2Timeline_create(framesCount: c_int, bezierCount: c_int, slotIndex: c_int) [*c]spRGBA2Timeline;
pub extern fn spRGBA2Timeline_setFrame(self: [*c]spRGBA2Timeline, frameIndex: c_int, time: f32, r: f32, g: f32, b: f32, a: f32, r2: f32, g2: f32, b2: f32) void;
pub const struct_spRGB2Timeline = extern struct {
    super: spCurveTimeline = @import("std").mem.zeroes(spCurveTimeline),
    slotIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spRGB2Timeline = struct_spRGB2Timeline;
pub extern fn spRGB2Timeline_create(framesCount: c_int, bezierCount: c_int, slotIndex: c_int) [*c]spRGB2Timeline;
pub extern fn spRGB2Timeline_setFrame(self: [*c]spRGB2Timeline, frameIndex: c_int, time: f32, r: f32, g: f32, b: f32, r2: f32, g2: f32, b2: f32) void;
pub const struct_spAttachmentTimeline = extern struct {
    super: spTimeline = @import("std").mem.zeroes(spTimeline),
    slotIndex: c_int = @import("std").mem.zeroes(c_int),
    attachmentNames: [*c][*c]u8 = @import("std").mem.zeroes([*c][*c]u8),
};
pub const spAttachmentTimeline = struct_spAttachmentTimeline;
pub extern fn spAttachmentTimeline_create(framesCount: c_int, SlotIndex: c_int) [*c]spAttachmentTimeline;
pub extern fn spAttachmentTimeline_setFrame(self: [*c]spAttachmentTimeline, frameIndex: c_int, time: f32, attachmentName: [*c]const u8) void;
pub const struct_spDeformTimeline = extern struct {
    super: spCurveTimeline = @import("std").mem.zeroes(spCurveTimeline),
    frameVerticesCount: c_int = @import("std").mem.zeroes(c_int),
    frameVertices: [*c][*c]f32 = @import("std").mem.zeroes([*c][*c]f32),
    slotIndex: c_int = @import("std").mem.zeroes(c_int),
    attachment: [*c]spAttachment = @import("std").mem.zeroes([*c]spAttachment),
};
pub const spDeformTimeline = struct_spDeformTimeline;
pub extern fn spDeformTimeline_create(framesCount: c_int, frameVerticesCount: c_int, bezierCount: c_int, slotIndex: c_int, attachment: [*c]spVertexAttachment) [*c]spDeformTimeline;
pub extern fn spDeformTimeline_setFrame(self: [*c]spDeformTimeline, frameIndex: c_int, time: f32, vertices: [*c]f32) void;
pub const struct_spSequenceTimeline = extern struct {
    super: spTimeline = @import("std").mem.zeroes(spTimeline),
    slotIndex: c_int = @import("std").mem.zeroes(c_int),
    attachment: [*c]spAttachment = @import("std").mem.zeroes([*c]spAttachment),
};
pub const spSequenceTimeline = struct_spSequenceTimeline;
pub extern fn spSequenceTimeline_create(framesCount: c_int, slotIndex: c_int, attachment: [*c]spAttachment) [*c]spSequenceTimeline;
pub extern fn spSequenceTimeline_setFrame(self: [*c]spSequenceTimeline, frameIndex: c_int, time: f32, mode: c_int, index: c_int, delay: f32) void;
pub const struct_spEventTimeline = extern struct {
    super: spTimeline = @import("std").mem.zeroes(spTimeline),
    events: [*c][*c]spEvent = @import("std").mem.zeroes([*c][*c]spEvent),
};
pub const spEventTimeline = struct_spEventTimeline;
pub extern fn spEventTimeline_create(framesCount: c_int) [*c]spEventTimeline;
pub extern fn spEventTimeline_setFrame(self: [*c]spEventTimeline, frameIndex: c_int, event: [*c]spEvent) void;
pub const struct_spDrawOrderTimeline = extern struct {
    super: spTimeline = @import("std").mem.zeroes(spTimeline),
    drawOrders: [*c][*c]c_int = @import("std").mem.zeroes([*c][*c]c_int),
    slotsCount: c_int = @import("std").mem.zeroes(c_int),
};
pub const spDrawOrderTimeline = struct_spDrawOrderTimeline;
pub extern fn spDrawOrderTimeline_create(framesCount: c_int, slotsCount: c_int) [*c]spDrawOrderTimeline;
pub extern fn spDrawOrderTimeline_setFrame(self: [*c]spDrawOrderTimeline, frameIndex: c_int, time: f32, drawOrder: [*c]const c_int) void;
pub const struct_spInheritTimeline = extern struct {
    super: spTimeline = @import("std").mem.zeroes(spTimeline),
    boneIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spInheritTimeline = struct_spInheritTimeline;
pub extern fn spInheritTimeline_create(framesCount: c_int, boneIndex: c_int) [*c]spInheritTimeline;
pub extern fn spInheritTimeline_setFrame(self: [*c]spInheritTimeline, frameIndex: c_int, time: f32, inherit: spInherit) void;
pub const struct_spIkConstraintTimeline = extern struct {
    super: spCurveTimeline = @import("std").mem.zeroes(spCurveTimeline),
    ikConstraintIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spIkConstraintTimeline = struct_spIkConstraintTimeline;
pub extern fn spIkConstraintTimeline_create(framesCount: c_int, bezierCount: c_int, transformConstraintIndex: c_int) [*c]spIkConstraintTimeline;
pub extern fn spIkConstraintTimeline_setFrame(self: [*c]spIkConstraintTimeline, frameIndex: c_int, time: f32, mix: f32, softness: f32, bendDirection: c_int, compress: c_int, stretch: c_int) void;
pub const struct_spTransformConstraintTimeline = extern struct {
    super: spCurveTimeline = @import("std").mem.zeroes(spCurveTimeline),
    transformConstraintIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spTransformConstraintTimeline = struct_spTransformConstraintTimeline;
pub extern fn spTransformConstraintTimeline_create(framesCount: c_int, bezierCount: c_int, transformConstraintIndex: c_int) [*c]spTransformConstraintTimeline;
pub extern fn spTransformConstraintTimeline_setFrame(self: [*c]spTransformConstraintTimeline, frameIndex: c_int, time: f32, mixRotate: f32, mixX: f32, mixY: f32, mixScaleX: f32, mixScaleY: f32, mixShearY: f32) void;
pub const struct_spPathConstraintPositionTimeline = extern struct {
    super: spCurveTimeline = @import("std").mem.zeroes(spCurveTimeline),
    pathConstraintIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spPathConstraintPositionTimeline = struct_spPathConstraintPositionTimeline;
pub extern fn spPathConstraintPositionTimeline_create(framesCount: c_int, bezierCount: c_int, pathConstraintIndex: c_int) [*c]spPathConstraintPositionTimeline;
pub extern fn spPathConstraintPositionTimeline_setFrame(self: [*c]spPathConstraintPositionTimeline, frameIndex: c_int, time: f32, value: f32) void;
pub const struct_spPathConstraintSpacingTimeline = extern struct {
    super: spCurveTimeline = @import("std").mem.zeroes(spCurveTimeline),
    pathConstraintIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spPathConstraintSpacingTimeline = struct_spPathConstraintSpacingTimeline;
pub extern fn spPathConstraintSpacingTimeline_create(framesCount: c_int, bezierCount: c_int, pathConstraintIndex: c_int) [*c]spPathConstraintSpacingTimeline;
pub extern fn spPathConstraintSpacingTimeline_setFrame(self: [*c]spPathConstraintSpacingTimeline, frameIndex: c_int, time: f32, value: f32) void;
pub const struct_spPathConstraintMixTimeline = extern struct {
    super: spCurveTimeline = @import("std").mem.zeroes(spCurveTimeline),
    pathConstraintIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spPathConstraintMixTimeline = struct_spPathConstraintMixTimeline;
pub extern fn spPathConstraintMixTimeline_create(framesCount: c_int, bezierCount: c_int, pathConstraintIndex: c_int) [*c]spPathConstraintMixTimeline;
pub extern fn spPathConstraintMixTimeline_setFrame(self: [*c]spPathConstraintMixTimeline, frameIndex: c_int, time: f32, mixRotate: f32, mixX: f32, mixY: f32) void;
pub const struct_spPhysicsConstraintTimeline = extern struct {
    super: spCurveTimeline = @import("std").mem.zeroes(spCurveTimeline),
    physicsConstraintIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spPhysicsConstraintTimeline = struct_spPhysicsConstraintTimeline;
pub extern fn spPhysicsConstraintTimeline_create(framesCount: c_int, bezierCount: c_int, physicsConstraintIndex: c_int, @"type": spTimelineType) [*c]spPhysicsConstraintTimeline;
pub extern fn spPhysicsConstraintTimeline_setFrame(self: [*c]spPhysicsConstraintTimeline, frame: c_int, time: f32, value: f32) void;
pub const struct_spPhysicsConstraintResetTimeline = extern struct {
    super: spTimeline = @import("std").mem.zeroes(spTimeline),
    physicsConstraintIndex: c_int = @import("std").mem.zeroes(c_int),
};
pub const spPhysicsConstraintResetTimeline = struct_spPhysicsConstraintResetTimeline;
pub extern fn spPhysicsConstraintResetTimeline_create(framesCount: c_int, boneIndex: c_int) [*c]spPhysicsConstraintResetTimeline;
pub extern fn spPhysicsConstraintResetTimeline_setFrame(self: [*c]spPhysicsConstraintResetTimeline, frameIndex: c_int, time: f32) void;
pub extern fn spIkConstraintData_create(name: [*c]const u8) [*c]spIkConstraintData;
pub extern fn spIkConstraintData_dispose(self: [*c]spIkConstraintData) void;
pub extern fn spTransformConstraintData_create(name: [*c]const u8) [*c]spTransformConstraintData;
pub extern fn spTransformConstraintData_dispose(self: [*c]spTransformConstraintData) void;
pub const SP_POSITION_MODE_FIXED: c_int = 0;
pub const SP_POSITION_MODE_PERCENT: c_int = 1;
pub const spPositionMode = c_uint;
pub const SP_SPACING_MODE_LENGTH: c_int = 0;
pub const SP_SPACING_MODE_FIXED: c_int = 1;
pub const SP_SPACING_MODE_PERCENT: c_int = 2;
pub const SP_SPACING_MODE_PROPORTIONAL: c_int = 3;
pub const spSpacingMode = c_uint;
pub const SP_ROTATE_MODE_TANGENT: c_int = 0;
pub const SP_ROTATE_MODE_CHAIN: c_int = 1;
pub const SP_ROTATE_MODE_CHAIN_SCALE: c_int = 2;
pub const spRotateMode = c_uint;
pub extern fn spPathConstraintData_create(name: [*c]const u8) [*c]spPathConstraintData;
pub extern fn spPathConstraintData_dispose(self: [*c]spPathConstraintData) void;
pub extern fn spPhysicsConstraintData_create(name: [*c]const u8) [*c]spPhysicsConstraintData;
pub extern fn spPhysicsConstraintData_dispose(self: [*c]spPhysicsConstraintData) void;
pub extern fn spBoneDataArray_create(initialCapacity: c_int) [*c]spBoneDataArray;
pub extern fn spBoneDataArray_dispose(self: [*c]spBoneDataArray) void;
pub extern fn spBoneDataArray_clear(self: [*c]spBoneDataArray) void;
pub extern fn spBoneDataArray_setSize(self: [*c]spBoneDataArray, newSize: c_int) [*c]spBoneDataArray;
pub extern fn spBoneDataArray_ensureCapacity(self: [*c]spBoneDataArray, newCapacity: c_int) void;
pub extern fn spBoneDataArray_add(self: [*c]spBoneDataArray, value: [*c]spBoneData) void;
pub extern fn spBoneDataArray_addAll(self: [*c]spBoneDataArray, other: [*c]spBoneDataArray) void;
pub extern fn spBoneDataArray_addAllValues(self: [*c]spBoneDataArray, values: [*c][*c]spBoneData, offset: c_int, count: c_int) void;
pub extern fn spBoneDataArray_removeAt(self: [*c]spBoneDataArray, index: c_int) void;
pub extern fn spBoneDataArray_contains(self: [*c]spBoneDataArray, value: [*c]spBoneData) c_int;
pub extern fn spBoneDataArray_pop(self: [*c]spBoneDataArray) [*c]spBoneData;
pub extern fn spBoneDataArray_peek(self: [*c]spBoneDataArray) [*c]spBoneData;
pub extern fn spIkConstraintDataArray_create(initialCapacity: c_int) [*c]spIkConstraintDataArray;
pub extern fn spIkConstraintDataArray_dispose(self: [*c]spIkConstraintDataArray) void;
pub extern fn spIkConstraintDataArray_clear(self: [*c]spIkConstraintDataArray) void;
pub extern fn spIkConstraintDataArray_setSize(self: [*c]spIkConstraintDataArray, newSize: c_int) [*c]spIkConstraintDataArray;
pub extern fn spIkConstraintDataArray_ensureCapacity(self: [*c]spIkConstraintDataArray, newCapacity: c_int) void;
pub extern fn spIkConstraintDataArray_add(self: [*c]spIkConstraintDataArray, value: [*c]spIkConstraintData) void;
pub extern fn spIkConstraintDataArray_addAll(self: [*c]spIkConstraintDataArray, other: [*c]spIkConstraintDataArray) void;
pub extern fn spIkConstraintDataArray_addAllValues(self: [*c]spIkConstraintDataArray, values: [*c][*c]spIkConstraintData, offset: c_int, count: c_int) void;
pub extern fn spIkConstraintDataArray_removeAt(self: [*c]spIkConstraintDataArray, index: c_int) void;
pub extern fn spIkConstraintDataArray_contains(self: [*c]spIkConstraintDataArray, value: [*c]spIkConstraintData) c_int;
pub extern fn spIkConstraintDataArray_pop(self: [*c]spIkConstraintDataArray) [*c]spIkConstraintData;
pub extern fn spIkConstraintDataArray_peek(self: [*c]spIkConstraintDataArray) [*c]spIkConstraintData;
pub extern fn spTransformConstraintDataArray_create(initialCapacity: c_int) [*c]spTransformConstraintDataArray;
pub extern fn spTransformConstraintDataArray_dispose(self: [*c]spTransformConstraintDataArray) void;
pub extern fn spTransformConstraintDataArray_clear(self: [*c]spTransformConstraintDataArray) void;
pub extern fn spTransformConstraintDataArray_setSize(self: [*c]spTransformConstraintDataArray, newSize: c_int) [*c]spTransformConstraintDataArray;
pub extern fn spTransformConstraintDataArray_ensureCapacity(self: [*c]spTransformConstraintDataArray, newCapacity: c_int) void;
pub extern fn spTransformConstraintDataArray_add(self: [*c]spTransformConstraintDataArray, value: [*c]spTransformConstraintData) void;
pub extern fn spTransformConstraintDataArray_addAll(self: [*c]spTransformConstraintDataArray, other: [*c]spTransformConstraintDataArray) void;
pub extern fn spTransformConstraintDataArray_addAllValues(self: [*c]spTransformConstraintDataArray, values: [*c][*c]spTransformConstraintData, offset: c_int, count: c_int) void;
pub extern fn spTransformConstraintDataArray_removeAt(self: [*c]spTransformConstraintDataArray, index: c_int) void;
pub extern fn spTransformConstraintDataArray_contains(self: [*c]spTransformConstraintDataArray, value: [*c]spTransformConstraintData) c_int;
pub extern fn spTransformConstraintDataArray_pop(self: [*c]spTransformConstraintDataArray) [*c]spTransformConstraintData;
pub extern fn spTransformConstraintDataArray_peek(self: [*c]spTransformConstraintDataArray) [*c]spTransformConstraintData;
pub extern fn spPathConstraintDataArray_create(initialCapacity: c_int) [*c]spPathConstraintDataArray;
pub extern fn spPathConstraintDataArray_dispose(self: [*c]spPathConstraintDataArray) void;
pub extern fn spPathConstraintDataArray_clear(self: [*c]spPathConstraintDataArray) void;
pub extern fn spPathConstraintDataArray_setSize(self: [*c]spPathConstraintDataArray, newSize: c_int) [*c]spPathConstraintDataArray;
pub extern fn spPathConstraintDataArray_ensureCapacity(self: [*c]spPathConstraintDataArray, newCapacity: c_int) void;
pub extern fn spPathConstraintDataArray_add(self: [*c]spPathConstraintDataArray, value: [*c]spPathConstraintData) void;
pub extern fn spPathConstraintDataArray_addAll(self: [*c]spPathConstraintDataArray, other: [*c]spPathConstraintDataArray) void;
pub extern fn spPathConstraintDataArray_addAllValues(self: [*c]spPathConstraintDataArray, values: [*c][*c]spPathConstraintData, offset: c_int, count: c_int) void;
pub extern fn spPathConstraintDataArray_removeAt(self: [*c]spPathConstraintDataArray, index: c_int) void;
pub extern fn spPathConstraintDataArray_contains(self: [*c]spPathConstraintDataArray, value: [*c]spPathConstraintData) c_int;
pub extern fn spPathConstraintDataArray_pop(self: [*c]spPathConstraintDataArray) [*c]spPathConstraintData;
pub extern fn spPathConstraintDataArray_peek(self: [*c]spPathConstraintDataArray) [*c]spPathConstraintData;
pub extern fn spPhysicsConstraintDataArray_create(initialCapacity: c_int) [*c]spPhysicsConstraintDataArray;
pub extern fn spPhysicsConstraintDataArray_dispose(self: [*c]spPhysicsConstraintDataArray) void;
pub extern fn spPhysicsConstraintDataArray_clear(self: [*c]spPhysicsConstraintDataArray) void;
pub extern fn spPhysicsConstraintDataArray_setSize(self: [*c]spPhysicsConstraintDataArray, newSize: c_int) [*c]spPhysicsConstraintDataArray;
pub extern fn spPhysicsConstraintDataArray_ensureCapacity(self: [*c]spPhysicsConstraintDataArray, newCapacity: c_int) void;
pub extern fn spPhysicsConstraintDataArray_add(self: [*c]spPhysicsConstraintDataArray, value: [*c]spPhysicsConstraintData) void;
pub extern fn spPhysicsConstraintDataArray_addAll(self: [*c]spPhysicsConstraintDataArray, other: [*c]spPhysicsConstraintDataArray) void;
pub extern fn spPhysicsConstraintDataArray_addAllValues(self: [*c]spPhysicsConstraintDataArray, values: [*c][*c]spPhysicsConstraintData, offset: c_int, count: c_int) void;
pub extern fn spPhysicsConstraintDataArray_removeAt(self: [*c]spPhysicsConstraintDataArray, index: c_int) void;
pub extern fn spPhysicsConstraintDataArray_contains(self: [*c]spPhysicsConstraintDataArray, value: [*c]spPhysicsConstraintData) c_int;
pub extern fn spPhysicsConstraintDataArray_pop(self: [*c]spPhysicsConstraintDataArray) [*c]spPhysicsConstraintData;
pub extern fn spPhysicsConstraintDataArray_peek(self: [*c]spPhysicsConstraintDataArray) [*c]spPhysicsConstraintData;
pub const _Entry = struct__Entry;
pub const struct__Entry = extern struct {
    slotIndex: c_int = @import("std").mem.zeroes(c_int),
    name: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    attachment: [*c]spAttachment = @import("std").mem.zeroes([*c]spAttachment),
    next: [*c]_Entry = @import("std").mem.zeroes([*c]_Entry),
};
pub const spSkinEntry = struct__Entry;
pub const _SkinHashTableEntry = struct__SkinHashTableEntry;
pub const struct__SkinHashTableEntry = extern struct {
    entry: [*c]_Entry = @import("std").mem.zeroes([*c]_Entry),
    next: [*c]_SkinHashTableEntry = @import("std").mem.zeroes([*c]_SkinHashTableEntry),
};
pub const _spSkin = extern struct {
    super: spSkin = @import("std").mem.zeroes(spSkin),
    entries: [*c]_Entry = @import("std").mem.zeroes([*c]_Entry),
    entriesHashTable: [100][*c]_SkinHashTableEntry = @import("std").mem.zeroes([100][*c]_SkinHashTableEntry),
};
pub extern fn spSkin_create(name: [*c]const u8) [*c]spSkin;
pub extern fn spSkin_dispose(self: [*c]spSkin) void;
pub extern fn spSkin_setAttachment(self: [*c]spSkin, slotIndex: c_int, name: [*c]const u8, attachment: [*c]spAttachment) void;
pub extern fn spSkin_getAttachment(self: [*c]const spSkin, slotIndex: c_int, name: [*c]const u8) [*c]spAttachment;
pub extern fn spSkin_getAttachmentName(self: [*c]const spSkin, slotIndex: c_int, attachmentIndex: c_int) [*c]const u8;
pub extern fn spSkin_attachAll(self: [*c]const spSkin, skeleton: [*c]struct_spSkeleton, oldspSkin: [*c]const spSkin) void;
pub extern fn spSkin_addSkin(self: [*c]spSkin, other: [*c]const spSkin) void;
pub extern fn spSkin_copySkin(self: [*c]spSkin, other: [*c]const spSkin) void;
pub extern fn spSkin_getAttachments(self: [*c]const spSkin) [*c]spSkinEntry;
pub extern fn spSkin_clear(self: [*c]spSkin) void;
pub extern fn spSkeletonData_create() [*c]spSkeletonData;
pub extern fn spSkeletonData_dispose(self: [*c]spSkeletonData) void;
pub extern fn spSkeletonData_findBone(self: [*c]const spSkeletonData, boneName: [*c]const u8) [*c]spBoneData;
pub extern fn spSkeletonData_findSlot(self: [*c]const spSkeletonData, slotName: [*c]const u8) [*c]spSlotData;
pub extern fn spSkeletonData_findSkin(self: [*c]const spSkeletonData, skinName: [*c]const u8) [*c]spSkin;
pub extern fn spSkeletonData_findEvent(self: [*c]const spSkeletonData, eventName: [*c]const u8) [*c]spEventData;
pub extern fn spSkeletonData_findAnimation(self: [*c]const spSkeletonData, animationName: [*c]const u8) [*c]spAnimation;
pub extern fn spSkeletonData_findIkConstraint(self: [*c]const spSkeletonData, constraintName: [*c]const u8) [*c]spIkConstraintData;
pub extern fn spSkeletonData_findTransformConstraint(self: [*c]const spSkeletonData, constraintName: [*c]const u8) [*c]spTransformConstraintData;
pub extern fn spSkeletonData_findPathConstraint(self: [*c]const spSkeletonData, constraintName: [*c]const u8) [*c]spPathConstraintData;
pub extern fn spSkeletonData_findPhysicsConstraint(self: [*c]const spSkeletonData, constraintName: [*c]const u8) [*c]spPhysicsConstraintData;
pub const struct_spAnimationStateData = extern struct {
    skeletonData: [*c]spSkeletonData = @import("std").mem.zeroes([*c]spSkeletonData),
    defaultMix: f32 = @import("std").mem.zeroes(f32),
    entries: ?*const anyopaque = @import("std").mem.zeroes(?*const anyopaque),
};
pub const spAnimationStateData = struct_spAnimationStateData;
pub extern fn spAnimationStateData_create(skeletonData: [*c]spSkeletonData) [*c]spAnimationStateData;
pub extern fn spAnimationStateData_dispose(self: [*c]spAnimationStateData) void;
pub extern fn spAnimationStateData_setMixByName(self: [*c]spAnimationStateData, fromName: [*c]const u8, toName: [*c]const u8, duration: f32) void;
pub extern fn spAnimationStateData_setMix(self: [*c]spAnimationStateData, from: [*c]spAnimation, to: [*c]spAnimation, duration: f32) void;
pub extern fn spAnimationStateData_getMix(self: [*c]spAnimationStateData, from: [*c]spAnimation, to: [*c]spAnimation) f32;
pub const SP_ANIMATION_START: c_int = 0;
pub const SP_ANIMATION_INTERRUPT: c_int = 1;
pub const SP_ANIMATION_END: c_int = 2;
pub const SP_ANIMATION_COMPLETE: c_int = 3;
pub const SP_ANIMATION_DISPOSE: c_int = 4;
pub const SP_ANIMATION_EVENT: c_int = 5;
pub const spEventType = c_uint;
pub const spAnimationState = struct_spAnimationState;
pub const spAnimationStateListener = ?*const fn ([*c]spAnimationState, spEventType, [*c]spTrackEntry, [*c]spEvent) callconv(.c) void;
pub const struct_spTrackEntryArray = extern struct {
    size: c_int = @import("std").mem.zeroes(c_int),
    capacity: c_int = @import("std").mem.zeroes(c_int),
    items: [*c][*c]spTrackEntry = @import("std").mem.zeroes([*c][*c]spTrackEntry),
};
pub const spTrackEntryArray = struct_spTrackEntryArray;
pub const struct_spTrackEntry = extern struct {
    animation: [*c]spAnimation = @import("std").mem.zeroes([*c]spAnimation),
    previous: [*c]spTrackEntry = @import("std").mem.zeroes([*c]spTrackEntry),
    next: [*c]spTrackEntry = @import("std").mem.zeroes([*c]spTrackEntry),
    mixingFrom: [*c]spTrackEntry = @import("std").mem.zeroes([*c]spTrackEntry),
    mixingTo: [*c]spTrackEntry = @import("std").mem.zeroes([*c]spTrackEntry),
    listener: spAnimationStateListener = @import("std").mem.zeroes(spAnimationStateListener),
    trackIndex: c_int = @import("std").mem.zeroes(c_int),
    loop: c_int = @import("std").mem.zeroes(c_int),
    holdPrevious: c_int = @import("std").mem.zeroes(c_int),
    reverse: c_int = @import("std").mem.zeroes(c_int),
    shortestRotation: c_int = @import("std").mem.zeroes(c_int),
    eventThreshold: f32 = @import("std").mem.zeroes(f32),
    mixAttachmentThreshold: f32 = @import("std").mem.zeroes(f32),
    alphaAttachmentThreshold: f32 = @import("std").mem.zeroes(f32),
    mixDrawOrderThreshold: f32 = @import("std").mem.zeroes(f32),
    animationStart: f32 = @import("std").mem.zeroes(f32),
    animationEnd: f32 = @import("std").mem.zeroes(f32),
    animationLast: f32 = @import("std").mem.zeroes(f32),
    nextAnimationLast: f32 = @import("std").mem.zeroes(f32),
    delay: f32 = @import("std").mem.zeroes(f32),
    trackTime: f32 = @import("std").mem.zeroes(f32),
    trackLast: f32 = @import("std").mem.zeroes(f32),
    nextTrackLast: f32 = @import("std").mem.zeroes(f32),
    trackEnd: f32 = @import("std").mem.zeroes(f32),
    timeScale: f32 = @import("std").mem.zeroes(f32),
    alpha: f32 = @import("std").mem.zeroes(f32),
    mixTime: f32 = @import("std").mem.zeroes(f32),
    mixDuration: f32 = @import("std").mem.zeroes(f32),
    interruptAlpha: f32 = @import("std").mem.zeroes(f32),
    totalAlpha: f32 = @import("std").mem.zeroes(f32),
    mixBlend: spMixBlend = @import("std").mem.zeroes(spMixBlend),
    timelineMode: [*c]spIntArray = @import("std").mem.zeroes([*c]spIntArray),
    timelineHoldMix: [*c]spTrackEntryArray = @import("std").mem.zeroes([*c]spTrackEntryArray),
    timelinesRotation: [*c]f32 = @import("std").mem.zeroes([*c]f32),
    timelinesRotationCount: c_int = @import("std").mem.zeroes(c_int),
    rendererObject: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    userData: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
pub const spTrackEntry = struct_spTrackEntry;
pub const struct_spAnimationState = extern struct {
    data: [*c]spAnimationStateData = @import("std").mem.zeroes([*c]spAnimationStateData),
    tracksCount: c_int = @import("std").mem.zeroes(c_int),
    tracks: [*c][*c]spTrackEntry = @import("std").mem.zeroes([*c][*c]spTrackEntry),
    listener: spAnimationStateListener = @import("std").mem.zeroes(spAnimationStateListener),
    timeScale: f32 = @import("std").mem.zeroes(f32),
    rendererObject: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    userData: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    unkeyedState: c_int = @import("std").mem.zeroes(c_int),
};
pub extern fn spTrackEntryArray_create(initialCapacity: c_int) [*c]spTrackEntryArray;
pub extern fn spTrackEntryArray_dispose(self: [*c]spTrackEntryArray) void;
pub extern fn spTrackEntryArray_clear(self: [*c]spTrackEntryArray) void;
pub extern fn spTrackEntryArray_setSize(self: [*c]spTrackEntryArray, newSize: c_int) [*c]spTrackEntryArray;
pub extern fn spTrackEntryArray_ensureCapacity(self: [*c]spTrackEntryArray, newCapacity: c_int) void;
pub extern fn spTrackEntryArray_add(self: [*c]spTrackEntryArray, value: [*c]spTrackEntry) void;
pub extern fn spTrackEntryArray_addAll(self: [*c]spTrackEntryArray, other: [*c]spTrackEntryArray) void;
pub extern fn spTrackEntryArray_addAllValues(self: [*c]spTrackEntryArray, values: [*c][*c]spTrackEntry, offset: c_int, count: c_int) void;
pub extern fn spTrackEntryArray_removeAt(self: [*c]spTrackEntryArray, index: c_int) void;
pub extern fn spTrackEntryArray_contains(self: [*c]spTrackEntryArray, value: [*c]spTrackEntry) c_int;
pub extern fn spTrackEntryArray_pop(self: [*c]spTrackEntryArray) [*c]spTrackEntry;
pub extern fn spTrackEntryArray_peek(self: [*c]spTrackEntryArray) [*c]spTrackEntry;
pub extern fn spAnimationState_create(data: [*c]spAnimationStateData) [*c]spAnimationState;
pub extern fn spAnimationState_dispose(self: [*c]spAnimationState) void;
pub extern fn spAnimationState_update(self: [*c]spAnimationState, delta: f32) void;
pub extern fn spAnimationState_apply(self: [*c]spAnimationState, skeleton: [*c]struct_spSkeleton) c_int;
pub extern fn spAnimationState_clearTracks(self: [*c]spAnimationState) void;
pub extern fn spAnimationState_clearTrack(self: [*c]spAnimationState, trackIndex: c_int) void;
pub extern fn spAnimationState_setAnimationByName(self: [*c]spAnimationState, trackIndex: c_int, animationName: [*c]const u8, loop: c_int) [*c]spTrackEntry;
pub extern fn spAnimationState_setAnimation(self: [*c]spAnimationState, trackIndex: c_int, animation: [*c]spAnimation, loop: c_int) [*c]spTrackEntry;
pub extern fn spAnimationState_addAnimationByName(self: [*c]spAnimationState, trackIndex: c_int, animationName: [*c]const u8, loop: c_int, delay: f32) [*c]spTrackEntry;
pub extern fn spAnimationState_addAnimation(self: [*c]spAnimationState, trackIndex: c_int, animation: [*c]spAnimation, loop: c_int, delay: f32) [*c]spTrackEntry;
pub extern fn spAnimationState_setEmptyAnimation(self: [*c]spAnimationState, trackIndex: c_int, mixDuration: f32) [*c]spTrackEntry;
pub extern fn spAnimationState_addEmptyAnimation(self: [*c]spAnimationState, trackIndex: c_int, mixDuration: f32, delay: f32) [*c]spTrackEntry;
pub extern fn spAnimationState_setEmptyAnimations(self: [*c]spAnimationState, mixDuration: f32) void;
pub extern fn spAnimationState_getCurrent(self: [*c]spAnimationState, trackIndex: c_int) [*c]spTrackEntry;
pub extern fn spAnimationState_clearListenerNotifications(self: [*c]spAnimationState) void;
pub extern fn spTrackEntry_getAnimationTime(entry: [*c]spTrackEntry) f32;
pub extern fn spTrackEntry_resetRotationDirections(entry: [*c]spTrackEntry) void;
pub extern fn spTrackEntry_getTrackComplete(entry: [*c]spTrackEntry) f32;
pub extern fn spTrackEntry_setMixDuration(entry: [*c]spTrackEntry, mixDuration: f32, delay: f32) void;
pub extern fn spTrackEntry_wasApplied(entry: [*c]spTrackEntry) c_int;
pub extern fn spTrackEntry_isNextReady(entry: [*c]spTrackEntry) c_int;
pub extern fn spAnimationState_clearNext(self: [*c]spAnimationState, entry: [*c]spTrackEntry) void;
pub extern fn spAnimationState_disposeStatics() void;
pub const spAttachmentLoader = struct_spAttachmentLoader;
pub extern fn spAttachmentLoader_dispose(self: [*c]spAttachmentLoader) void;
pub extern fn spAttachmentLoader_createAttachment(self: [*c]spAttachmentLoader, skin: [*c]spSkin, @"type": spAttachmentType, name: [*c]const u8, path: [*c]const u8, sequence: [*c]spSequence) [*c]spAttachment;
pub extern fn spAttachmentLoader_configureAttachment(self: [*c]spAttachmentLoader, attachment: [*c]spAttachment) void;
pub extern fn spAttachmentLoader_disposeAttachment(self: [*c]spAttachmentLoader, attachment: [*c]spAttachment) void;
pub const struct_spAtlasAttachmentLoader = extern struct {
    super: spAttachmentLoader = @import("std").mem.zeroes(spAttachmentLoader),
    atlas: [*c]spAtlas = @import("std").mem.zeroes([*c]spAtlas),
};
pub const spAtlasAttachmentLoader = struct_spAtlasAttachmentLoader;
pub extern fn spAtlasAttachmentLoader_create(atlas: [*c]spAtlas) [*c]spAtlasAttachmentLoader;
pub const struct_spRegionAttachment = extern struct {
    super: spAttachment = @import("std").mem.zeroes(spAttachment),
    ...
    color: spColor = @import("std").mem.zeroes(spColor),
    rendererObject: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    region: [*c]spTextureRegion = @import("std").mem.zeroes([*c]spTextureRegion),
    sequence: [*c]spSequence = @import("std").mem.zeroes([*c]spSequence),
    offset: [8]f32 = @import("std").mem.zeroes([8]f32),
    uvs: [8]f32 = @import("std").mem.zeroes([8]f32),
};
pub const spRegionAttachment = struct_spRegionAttachment;
pub extern fn spRegionAttachment_create(name: [*c]const u8) [*c]spRegionAttachment;
pub extern fn spRegionAttachment_updateRegion(self: [*c]spRegionAttachment) void;
pub extern fn spRegionAttachment_computeWorldVertices(self: [*c]spRegionAttachment, slot: [*c]spSlot, vertices: [*c]f32, offset: c_int, stride: c_int) void;
pub const spMeshAttachment = struct_spMeshAttachment;
pub const struct_spMeshAttachment = extern struct {
    super: spVertexAttachment = @import("std").mem.zeroes(spVertexAttachment),
    rendererObject: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    region: [*c]spTextureRegion = @import("std").mem.zeroes([*c]spTextureRegion),
    sequence: [*c]spSequence = @import("std").mem.zeroes([*c]spSequence),
    path: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    regionUVs: [*c]f32 = @import("std").mem.zeroes([*c]f32),
    uvs: [*c]f32 = @import("std").mem.zeroes([*c]f32),
    trianglesCount: c_int = @import("std").mem.zeroes(c_int),
    triangles: [*c]c_ushort = @import("std").mem.zeroes([*c]c_ushort),
    color: spColor = @import("std").mem.zeroes(spColor),
    hullLength: c_int = @import("std").mem.zeroes(c_int),
    parentMesh: [*c]spMeshAttachment = @import("std").mem.zeroes([*c]spMeshAttachment),
    edgesCount: c_int = @import("std").mem.zeroes(c_int),
    edges: [*c]c_ushort = @import("std").mem.zeroes([*c]c_ushort),
    width: f32 = @import("std").mem.zeroes(f32),
    height: f32 = @import("std").mem.zeroes(f32),
};
pub extern fn spMeshAttachment_create(name: [*c]const u8) [*c]spMeshAttachment;
pub extern fn spMeshAttachment_updateRegion(self: [*c]spMeshAttachment) void;
pub extern fn spMeshAttachment_setParentMesh(self: [*c]spMeshAttachment, parentMesh: [*c]spMeshAttachment) void;
pub extern fn spMeshAttachment_newLinkedMesh(self: [*c]spMeshAttachment) [*c]spMeshAttachment;
pub const struct_spBoundingBoxAttachment = extern struct {
    super: spVertexAttachment = @import("std").mem.zeroes(spVertexAttachment),
    color: spColor = @import("std").mem.zeroes(spColor),
};
pub const spBoundingBoxAttachment = struct_spBoundingBoxAttachment;
pub extern fn spBoundingBoxAttachment_create(name: [*c]const u8) [*c]spBoundingBoxAttachment;
pub const struct_spClippingAttachment = extern struct {
    super: spVertexAttachment = @import("std").mem.zeroes(spVertexAttachment),
    endSlot: [*c]spSlotData = @import("std").mem.zeroes([*c]spSlotData),
    color: spColor = @import("std").mem.zeroes(spColor),
};
pub const spClippingAttachment = struct_spClippingAttachment;
pub extern fn _spClippingAttachment_dispose(self: [*c]spAttachment) void;
pub extern fn spClippingAttachment_create(name: [*c]const u8) [*c]spClippingAttachment;
pub const struct_spPointAttachment = extern struct {
    super: spAttachment = @import("std").mem.zeroes(spAttachment),
    x: f32 = @import("std").mem.zeroes(f32),
    y: f32 = @import("std").mem.zeroes(f32),
    rotation: f32 = @import("std").mem.zeroes(f32),
...
pub const spPointAttachment = struct_spPointAttachment;
pub extern fn spPointAttachment_create(name: [*c]const u8) [*c]spPointAttachment;
pub extern fn spPointAttachment_computeWorldPosition(self: [*c]spPointAttachment, bone: [*c]spBone, x: [*c]f32, y: [*c]f32) void;
pub extern fn spPointAttachment_computeWorldRotation(self: [*c]spPointAttachment, bone: [*c]spBone) f32;
pub extern fn spIkConstraint_create(data: [*c]spIkConstraintData, skeleton: [*c]const struct_spSkeleton) [*c]spIkConstraint;
pub extern fn spIkConstraint_dispose(self: [*c]spIkConstraint) void;
pub extern fn spIkConstraint_update(self: [*c]spIkConstraint) void;
pub extern fn spIkConstraint_setToSetupPose(self: [*c]spIkConstraint) void;
pub extern fn spIkConstraint_apply1(bone: [*c]spBone, targetX: f32, targetY: f32, compress: c_int, stretch: c_int, uniform: c_int, alpha: f32) void;
pub extern fn spIkConstraint_apply2(parent: [*c]spBone, child: [*c]spBone, targetX: f32, targetY: f32, bendDirection: c_int, stretch: c_int, uniform: c_int, softness: f32, alpha: f32) void;
pub extern fn spTransformConstraint_create(data: [*c]spTransformConstraintData, skeleton: [*c]const struct_spSkeleton) [*c]spTransformConstraint;
pub extern fn spTransformConstraint_dispose(self: [*c]spTransformConstraint) void;
pub extern fn spTransformConstraint_update(self: [*c]spTransformConstraint) void;
pub extern fn spTransformConstraint_setToSetupPose(self: [*c]spTransformConstraint) void;
pub const struct_spPathAttachment = extern struct {
    super: spVertexAttachment = @import("std").mem.zeroes(spVertexAttachment),
    lengthsLength: c_int = @import("std").mem.zeroes(c_int),
    lengths: [*c]f32 = @import("std").mem.zeroes([*c]f32),
    closed: c_int = @import("std").mem.zeroes(c_int),
    constantSpeed: c_int = @import("std").mem.zeroes(c_int),
    color: spColor = @import("std").mem.zeroes(spColor),
};
pub const spPathAttachment = struct_spPathAttachment;
pub extern fn spPathAttachment_create(name: [*c]const u8) [*c]spPathAttachment;
pub extern fn spPathConstraint_create(data: [*c]spPathConstraintData, skeleton: [*c]const struct_spSkeleton) [*c]spPathConstraint;
pub extern fn spPathConstraint_dispose(self: [*c]spPathConstraint) void;
pub extern fn spPathConstraint_update(self: [*c]spPathConstraint) void;
pub extern fn spPathConstraint_setToSetupPose(self: [*c]spPathConstraint) void;
pub extern fn spPathConstraint_computeWorldPositions(self: [*c]spPathConstraint, path: [*c]spPathAttachment, spacesCount: c_int, tangents: c_int) [*c]f32;
pub extern fn spPhysicsConstraint_create(data: [*c]spPhysicsConstraintData, skeleton: [*c]struct_spSkeleton) [*c]spPhysicsConstraint;
pub extern fn spPhysicsConstraint_dispose(self: [*c]spPhysicsConstraint) void;
pub extern fn spPhysicsConstraint_reset(self: [*c]spPhysicsConstraint) void;
pub extern fn spPhysicsConstraint_setToSetupPose(self: [*c]spPhysicsConstraint) void;
pub extern fn spPhysicsConstraint_update(self: [*c]spPhysicsConstraint, physics: spPhysics) void;
pub extern fn spPhysicsConstraint_rotate(self: [*c]spPhysicsConstraint, x: f32, y: f32, degrees: f32) void;
pub extern fn spPhysicsConstraint_translate(self: [*c]spPhysicsConstraint, x: f32, y: f32) void;
pub const spSkeleton = struct_spSkeleton;
pub extern fn spSkeleton_create(data: [*c]spSkeletonData) [*c]spSkeleton;
pub extern fn spSkeleton_dispose(self: [*c]spSkeleton) void;
pub extern fn spSkeleton_updateCache(self: [*c]spSkeleton) void;
pub extern fn spSkeleton_updateWorldTransform(self: [*c]const spSkeleton, physics: spPhysics) void;
pub extern fn spSkeleton_update(self: [*c]spSkeleton, delta: f32) void;
pub extern fn spSkeleton_setToSetupPose(self: [*c]const spSkeleton) void;
pub extern fn spSkeleton_setBonesToSetupPose(self: [*c]const spSkeleton) void;
pub extern fn spSkeleton_setSlotsToSetupPose(self: [*c]const spSkeleton) void;
pub extern fn spSkeleton_findBone(self: [*c]const spSkeleton, boneName: [*c]const u8) [*c]spBone;
pub extern fn spSkeleton_findSlot(self: [*c]const spSkeleton, slotName: [*c]const u8) [*c]spSlot;
pub extern fn spSkeleton_setSkin(self: [*c]spSkeleton, skin: [*c]spSkin) void;
pub extern fn spSkeleton_setSkinByName(self: [*c]spSkeleton, skinName: [*c]const u8) c_int;
pub extern fn spSkeleton_getAttachmentForSlotName(self: [*c]const spSkeleton, slotName: [*c]const u8, attachmentName: [*c]const u8) [*c]spAttachment;
pub extern fn spSkeleton_getAttachmentForSlotIndex(self: [*c]const spSkeleton, slotIndex: c_int, attachmentName: [*c]const u8) [*c]spAttachment;
pub extern fn spSkeleton_setAttachment(self: [*c]spSkeleton, slotName: [*c]const u8, attachmentName: [*c]const u8) c_int;
pub extern fn spSkeleton_findIkConstraint(self: [*c]const spSkeleton, constraintName: [*c]const u8) [*c]spIkConstraint;
pub extern fn spSkeleton_findTransformConstraint(self: [*c]const spSkeleton, constraintName: [*c]const u8) [*c]spTransformConstraint;
pub extern fn spSkeleton_findPathConstraint(self: [*c]const spSkeleton, constraintName: [*c]const u8) [*c]spPathConstraint;
pub extern fn spSkeleton_findPhysicsConstraint(self: [*c]const spSkeleton, constraintName: [*c]const u8) [*c]spPhysicsConstraint;
pub extern fn spSkeleton_physicsTranslate(self: [*c]spSkeleton, x: f32, y: f32) void;
pub extern fn spSkeleton_physicsRotate(self: [*c]spSkeleton, x: f32, y: f32, degrees: f32) void;
pub const struct_spPolygon = extern struct {
    vertices: [*c]f32 = @import("std").mem.zeroes([*c]f32),
    count: c_int = @import("std").mem.zeroes(c_int),
    capacity: c_int = @import("std").mem.zeroes(c_int),
};
pub const spPolygon = struct_spPolygon;
pub extern fn spPolygon_create(capacity: c_int) [*c]spPolygon;
pub extern fn spPolygon_dispose(self: [*c]spPolygon) void;
pub extern fn spPolygon_containsPoint(polygon: [*c]spPolygon, x: f32, y: f32) c_int;
pub extern fn spPolygon_intersectsSegment(polygon: [*c]spPolygon, x1: f32, y1: f32, x2: f32, y2: f32) c_int;
pub const struct_spSkeletonBounds = extern struct {
    count: c_int = @import("std").mem.zeroes(c_int),
    boundingBoxes: [*c][*c]spBoundingBoxAttachment = @import("std").mem.zeroes([*c][*c]spBoundingBoxAttachment),
    polygons: [*c][*c]spPolygon = @import("std").mem.zeroes([*c][*c]spPolygon),
...
pub const spSkeletonBounds = struct_spSkeletonBounds;
pub extern fn spSkeletonBounds_create() [*c]spSkeletonBounds;
pub extern fn spSkeletonBounds_dispose(self: [*c]spSkeletonBounds) void;
pub extern fn spSkeletonBounds_update(self: [*c]spSkeletonBounds, skeleton: [*c]spSkeleton, updateAabb: c_int) void;
pub extern fn spSkeletonBounds_aabbContainsPoint(self: [*c]spSkeletonBounds, x: f32, y: f32) c_int;
pub extern fn spSkeletonBounds_aabbIntersectsSegment(self: [*c]spSkeletonBounds, x1: f32, y1: f32, x2: f32, y2: f32) c_int;
pub extern fn spSkeletonBounds_aabbIntersectsSkeleton(self: [*c]spSkeletonBounds, bounds: [*c]spSkeletonBounds) c_int;
pub extern fn spSkeletonBounds_containsPoint(self: [*c]spSkeletonBounds, x: f32, y: f32) [*c]spBoundingBoxAttachment;
pub extern fn spSkeletonBounds_intersectsSegment(self: [*c]spSkeletonBounds, x1: f32, y1: f32, x2: f32, y2: f32) [*c]spBoundingBoxAttachment;
pub extern fn spSkeletonBounds_getPolygon(self: [*c]spSkeletonBounds, boundingBox: [*c]spBoundingBoxAttachment) [*c]spPolygon;
pub const struct_spSkeletonBinary = extern struct {
    scale: f32 = @import("std").mem.zeroes(f32),
    attachmentLoader: [*c]spAttachmentLoader = @import("std").mem.zeroes([*c]spAttachmentLoader),
    @"error": [*c]u8 = @import("std").mem.zeroes([*c]u8),
};
pub const spSkeletonBinary = struct_spSkeletonBinary;
pub extern fn spSkeletonBinary_createWithLoader(attachmentLoader: [*c]spAttachmentLoader) [*c]spSkeletonBinary;
pub extern fn spSkeletonBinary_create(atlas: [*c]spAtlas) [*c]spSkeletonBinary;
pub extern fn spSkeletonBinary_dispose(self: [*c]spSkeletonBinary) void;
pub extern fn spSkeletonBinary_readSkeletonData(self: [*c]spSkeletonBinary, binary: [*c]const u8, length: c_int) [*c]spSkeletonData;
pub extern fn spSkeletonBinary_readSkeletonDataFile(self: [*c]spSkeletonBinary, path: [*c]const u8) [*c]spSkeletonData;
pub const struct_spSkeletonJson = extern struct {
    scale: f32 = @import("std").mem.zeroes(f32),
    attachmentLoader: [*c]spAttachmentLoader = @import("std").mem.zeroes([*c]spAttachmentLoader),
    @"error": [*c]u8 = @import("std").mem.zeroes([*c]u8),
};
pub const spSkeletonJson = struct_spSkeletonJson;
pub extern fn spSkeletonJson_createWithLoader(attachmentLoader: [*c]spAttachmentLoader) [*c]spSkeletonJson;
pub extern fn spSkeletonJson_create(atlas: [*c]spAtlas) [*c]spSkeletonJson;
pub extern fn spSkeletonJson_dispose(self: [*c]spSkeletonJson) void;
pub extern fn spSkeletonJson_readSkeletonData(self: [*c]spSkeletonJson, json: [*c]const u8) [*c]spSkeletonData;
pub extern fn spSkeletonJson_readSkeletonDataFile(self: [*c]spSkeletonJson, path: [*c]const u8) [*c]spSkeletonData;
pub const struct_spTriangulator = extern struct {
    convexPolygons: [*c]spArrayFloatArray = @import("std").mem.zeroes([*c]spArrayFloatArray),
    convexPolygonsIndices: [*c]spArrayShortArray = @import("std").mem.zeroes([*c]spArrayShortArray),
    indicesArray: [*c]spShortArray = @import("std").mem.zeroes([*c]spShortArray),
    isConcaveArray: [*c]spIntArray = @import("std").mem.zeroes([*c]spIntArray),
    triangles: [*c]spShortArray = @import("std").mem.zeroes([*c]spShortArray),
    polygonPool: [*c]spArrayFloatArray = @import("std").mem.zeroes([*c]spArrayFloatArray),
    polygonIndicesPool: [*c]spArrayShortArray = @import("std").mem.zeroes([*c]spArrayShortArray),
};
pub const spTriangulator = struct_spTriangulator;
pub extern fn spTriangulator_create() [*c]spTriangulator;
pub extern fn spTriangulator_triangulate(self: [*c]spTriangulator, verticesArray: [*c]spFloatArray) [*c]spShortArray;
pub extern fn spTriangulator_decompose(self: [*c]spTriangulator, verticesArray: [*c]spFloatArray, triangles: [*c]spShortArray) [*c]spArrayFloatArray;
pub extern fn spTriangulator_dispose(self: [*c]spTriangulator) void;
pub const struct_spSkeletonClipping = extern struct {
    triangulator: [*c]spTriangulator = @import("std").mem.zeroes([*c]spTriangulator),
    clippingPolygon: [*c]spFloatArray = @import("std").mem.zeroes([*c]spFloatArray),
    clipOutput: [*c]spFloatArray = @import("std").mem.zeroes([*c]spFloatArray),
    clippedVertices: [*c]spFloatArray = @import("std").mem.zeroes([*c]spFloatArray),
    clippedUVs: [*c]spFloatArray = @import("std").mem.zeroes([*c]spFloatArray),
    clippedTriangles: [*c]spUnsignedShortArray = @import("std").mem.zeroes([*c]spUnsignedShortArray),
    scratch: [*c]spFloatArray = @import("std").mem.zeroes([*c]spFloatArray),
    clipAttachment: [*c]spClippingAttachment = @import("std").mem.zeroes([*c]spClippingAttachment),
    clippingPolygons: [*c]spArrayFloatArray = @import("std").mem.zeroes([*c]spArrayFloatArray),
};
pub const spSkeletonClipping = struct_spSkeletonClipping;
pub extern fn spSkeletonClipping_create() [*c]spSkeletonClipping;
pub extern fn spSkeletonClipping_clipStart(self: [*c]spSkeletonClipping, slot: [*c]spSlot, clip: [*c]spClippingAttachment) c_int;
pub extern fn spSkeletonClipping_clipEnd(self: [*c]spSkeletonClipping, slot: [*c]spSlot) void;
pub extern fn spSkeletonClipping_clipEnd2(self: [*c]spSkeletonClipping) void;
pub extern fn spSkeletonClipping_isClipping(self: [*c]spSkeletonClipping) c_int;
pub extern fn spSkeletonClipping_clipTriangles(self: [*c]spSkeletonClipping, vertices: [*c]f32, verticesLength: c_int, triangles: [*c]c_ushort, trianglesLength: c_int, uvs: [*c]f32, stride: c_int) void;
pub extern fn spSkeletonClipping_dispose(self: [*c]spSkeletonClipping) void;
...
pub extern fn _spAtlasPage_createTexture(self: [*c]spAtlasPage, path: [*c]const u8) void;
pub extern fn _spAtlasPage_disposeTexture(self: [*c]spAtlasPage) void;
pub extern fn _spUtil_readFile(path: [*c]const u8, length: [*c]c_int) [*c]u8;
pub extern fn _spMalloc(size: usize, file: [*c]const u8, line: c_int) ?*anyopaque;
pub extern fn _spCalloc(num: usize, size: usize, file: [*c]const u8, line: c_int) ?*anyopaque;
pub extern fn _spRealloc(ptr: ?*anyopaque, size: usize) ?*anyopaque;
pub extern fn _spFree(ptr: ?*anyopaque) void;
pub extern fn _spRandom() f32;
pub extern fn _spSetMalloc(_malloc: ?*const fn (usize) callconv(.c) ?*anyopaque) void;
pub extern fn _spSetDebugMalloc(_malloc: ?*const fn (usize, [*c]const u8, c_int) callconv(.c) ?*anyopaque) void;
pub extern fn _spSetRealloc(_realloc: ?*const fn (?*anyopaque, usize) callconv(.c) ?*anyopaque) void;
pub extern fn _spSetFree(_free: ?*const fn (?*anyopaque) callconv(.c) void) void;
pub extern fn _spSetRandom(_random: ?*const fn () callconv(.c) f32) void;
pub extern fn _spReadFile(path: [*c]const u8, length: [*c]c_int) [*c]u8;
pub extern fn _spMath_random(min: f32, max: f32) f32;
pub extern fn _spMath_randomTriangular(min: f32, max: f32) f32;
pub extern fn _spMath_randomTriangularWith(min: f32, max: f32, mode: f32) f32;
pub extern fn _spMath_interpolate(apply: ?*const fn (f32) callconv(.c) f32, start: f32, end: f32, a: f32) f32;
pub extern fn _spMath_pow2_apply(a: f32) f32;
pub extern fn _spMath_pow2out_apply(a: f32) f32;
pub const union__spEventQueueItem = extern union {
    type: c_int,
    entry: [*c]spTrackEntry,
    event: [*c]spEvent,
};
pub const _spEventQueueItem = union__spEventQueueItem;
pub const _spAnimationState = struct__spAnimationState;
pub const struct__spEventQueue = extern struct {
    state: [*c]_spAnimationState = @import("std").mem.zeroes([*c]_spAnimationState),
    objects: [*c]_spEventQueueItem = @import("std").mem.zeroes([*c]_spEventQueueItem),
    objectsCount: c_int = @import("std").mem.zeroes(c_int),
    objectsCapacity: c_int = @import("std").mem.zeroes(c_int),
    drainDisabled: c_int = @import("std").mem.zeroes(c_int),
};
pub const _spEventQueue = struct__spEventQueue;
pub const struct__spAnimationState = extern struct {
    super: spAnimationState = @import("std").mem.zeroes(spAnimationState),
    eventsCount: c_int = @import("std").mem.zeroes(c_int),
    events: [*c][*c]spEvent = @import("std").mem.zeroes([*c][*c]spEvent),
    queue: [*c]_spEventQueue = @import("std").mem.zeroes([*c]_spEventQueue),
    propertyIDs: [*c]spPropertyId = @import("std").mem.zeroes([*c]spPropertyId),
    propertyIDsCount: c_int = @import("std").mem.zeroes(c_int),
    propertyIDsCapacity: c_int = @import("std").mem.zeroes(c_int),
    animationsChanged: c_int = @import("std").mem.zeroes(c_int),
};
pub extern fn _spAttachmentLoader_init(self: [*c]spAttachmentLoader, dispose: ?*const fn ([*c]spAttachmentLoader) callconv(.c) void, createAttachment: ?*const fn ([*c]spAttachmentLoader, [*c]spSkin, spAttachmentType, [*c]const u8, [*c]const u8, [*c]spSequence) callconv(.c) [*c]spAttachment, configureAttachment: ?*const fn ([*c]spAttachmentLoader, [*c]spAttachment) callconv(.c) void, disposeAttachment: ?*const fn ([*c]spAttachmentLoader, [*c]spAttachment) callconv(.c) void) void;
pub extern fn _spAttachmentLoader_deinit(self: [*c]spAttachmentLoader) void;
pub extern fn _spAttachmentLoader_setError(self: [*c]spAttachmentLoader, error1: [*c]const u8, error2: [*c]const u8) void;
pub extern fn _spAttachmentLoader_setUnknownTypeError(self: [*c]spAttachmentLoader, @"type": spAttachmentType) void;
pub extern fn _spAttachment_init(self: [*c]spAttachment, name: [*c]const u8, @"type": spAttachmentType, dispose: ?*const fn ([*c]spAttachment) callconv(.c) void, copy: ?*const fn ([*c]spAttachment) callconv(.c) [*c]spAttachment) void;
pub extern fn _spAttachment_deinit(self: [*c]spAttachment) void;
pub extern fn _spVertexAttachment_init(self: [*c]spVertexAttachment) void;
pub extern fn _spVertexAttachment_deinit(self: [*c]spVertexAttachment) void;
...
pub const SPINE_ALL_H_ = "";
pub const SPINE_SPINE_H_ = "";
pub const SPINE_SHAREDLIB_H = "";
pub const DLLIMPORT = "";
pub const DLLEXPORT = "";
pub const SP_API = "";
pub const SPINE_ARRAY_H = "";
pub const _SP_ARRAY_DECLARE_TYPE = @compileError("unable to translate macro: untranslatable usage of arg `name`");
// spine-runtimes/spine-c/spine-c/include/spine/Array.h:39:9
pub const _SP_ARRAY_IMPLEMENT_TYPE = @compileError("unable to translate macro: undefined identifier `_create`");
// spine-runtimes/spine-c/spine-c/include/spine/Array.h:54:9
pub const _SP_ARRAY_IMPLEMENT_TYPE_NO_CONTAINS = @compileError("unable to translate macro: undefined identifier `_create`");
// spine-runtimes/spine-c/spine-c/include/spine/Array.h:121:9
pub const SPINE_ANIMATION_H_ = "";
pub const SPINE_EVENT_H_ = "";
pub const SPINE_EVENTDATA_H_ = "";
pub const SPINE_ATTACHMENT_H_ = "";
pub const SPINE_VERTEXATTACHMENT_H_ = "";
pub const SPINE_SLOT_H_ = "";
pub const SPINE_BONE_H_ = "";
pub const SPINE_BONEDATA_H_ = "";
pub const SPINE_COLOR_H_ = "";
pub const SPINE_PHYSICS_H_ = "";
pub const SPINE_SLOTDATA_H_ = "";
pub const SPINE_SEQUENCE_H = "";
pub const SPINE_TEXTURE_REGION_H = "";
pub const SPINE_ATLAS_H_ = "";
pub const SP_SEQUENCE_MODE_HOLD = @as(c_int, 0);
pub const SP_SEQUENCE_MODE_ONCE = @as(c_int, 1);
pub const SP_SEQUENCE_MODE_LOOP = @as(c_int, 2);
pub const SP_SEQUENCE_MODE_PINGPONG = @as(c_int, 3);
pub const SP_SEQUENCE_MODE_ONCEREVERSE = @as(c_int, 4);
pub const SP_SEQUENCE_MODE_LOOPREVERSE = @as(c_int, 5);
pub const SP_SEQUENCE_MODE_PINGPONGREVERSE = @as(c_int, 6);
...
pub const SP_MAX_PROPERTY_IDS = @as(c_int, 3);
pub const SPINE_ANIMATIONSTATE_H_ = "";
pub const SPINE_ANIMATIONSTATEDATA_H_ = "";
pub const SPINE_SKELETONDATA_H_ = "";
pub const SPINE_SKIN_H_ = "";
pub const SPINE_IKCONSTRAINTDATA_H_ = "";
pub const SPINE_TRANSFORMCONSTRAINTDATA_H_ = "";
pub const SPINE_PATHCONSTRAINTDATA_H_ = "";
pub const SPINE_PHYSICSCONSTRAINTDATA_H_ = "";
pub const SKIN_ENTRIES_HASH_TABLE_SIZE = @as(c_int, 100);
pub const SPINE_ATLASATTACHMENTLOADER_H_ = "";
pub const SPINE_ATTACHMENTLOADER_H_ = "";
pub const SPINE_REGIONATTACHMENT_H_ = "";
pub const SPINE_MESHATTACHMENT_H_ = "";
pub const SPINE_BOUNDINGBOXATTACHMENT_H_ = "";
pub const SPINE_CLIPPINGATTACHMENT_H_ = "";
pub const SPINE_POINTATTACHMENT_H_ = "";
pub const SPINE_SKELETON_H_ = "";
pub const SPINE_IKCONSTRAINT_H_ = "";
pub const SPINE_TRANSFORMCONSTRAINT_H_ = "";
pub const SPINE_PATHCONSTRAINT_H_ = "";
pub const SPINE_PATHATTACHMENT_H_ = "";
pub const SP_PATHCONSTRAINT_ = "";
pub const SPINE_PHYSICSCONSTRAINT_H_ = "";
pub const SPINE_SKELETONBOUNDS_H_ = "";
pub const SPINE_SKELETONBINARY_H_ = "";
pub const SPINE_SKELETONJSON_H_ = "";
pub const SPINE_SKELETONCLIPPING_H = "";
pub const SPINE_TRIANGULATOR_H = "";
pub const SPINE_EXTENSION_H_ = "";
pub const MALLOC = @compileError("unable to translate macro: undefined identifier `__FILE__`");
// spine-runtimes/spine-c/spine-c/include/spine/extension.h:70:9
pub const CALLOC = @compileError("unable to translate macro: undefined identifier `__FILE__`");
// spine-runtimes/spine-c/spine-c/include/spine/extension.h:71:9
pub const REALLOC = @compileError("unable to translate C expr: unexpected token ')'");
// spine-runtimes/spine-c/spine-c/include/spine/extension.h:72:9
pub inline fn NEW(TYPE: anytype) @TypeOf(CALLOC(TYPE, @as(c_int, 1))) {
    _ = &TYPE;
    return CALLOC(TYPE, @as(c_int, 1));
}
pub inline fn SUPER(VALUE: anytype) @TypeOf(&VALUE.*.super) {
    _ = &VALUE;
    return &VALUE.*.super;
}
pub const SUPER_CAST = @compileError("unable to translate C expr: unexpected token ')'");
// spine-runtimes/spine-c/spine-c/include/spine/extension.h:79:9
pub const SUB_CAST = @compileError("unable to translate C expr: unexpected token ')'");
// spine-runtimes/spine-c/spine-c/include/spine/extension.h:82:9
pub const VTABLE = @compileError("unable to translate macro: undefined identifier `_`");
// spine-runtimes/spine-c/spine-c/include/spine/extension.h:85:9
pub inline fn FREE(VALUE: anytype) @TypeOf(_spFree(@import("std").zig.c_translation.cast(?*anyopaque, VALUE))) {
    _ = &VALUE;
    return _spFree(@import("std").zig.c_translation.cast(?*anyopaque, VALUE));
}
pub const MALLOC_STR = @compileError("unable to translate C expr: expected ',' or ')' instead got '='");
// spine-runtimes/spine-c/spine-c/include/spine/extension.h:91:9
pub const PI = @as(f32, 3.1415926535897932385);
pub const PI2 = PI * @as(c_int, 2);
pub const INV_PI2 = @import("std").zig.c_translation.MacroArithmetic.div(@as(c_int, 1), PI2);
pub const DEG_RAD = @import("std").zig.c_translation.MacroArithmetic.div(PI, @as(c_int, 180));
pub const RAD_DEG = @import("std").zig.c_translation.MacroArithmetic.div(@as(c_int, 180), PI);
pub inline fn ABS(A: anytype) @TypeOf(if (A < @as(c_int, 0)) -A else A) {
    _ = &A;
    return if (A < @as(c_int, 0)) -A else A;
}
pub inline fn SIGNUM(A: anytype) @TypeOf(if (A < @as(c_int, 0)) -@as(f32, 1.0) else if (A > @as(c_int, 0)) @as(f32, 1.0) else @as(f32, 0.0)) {
    _ = &A;
    return if (A < @as(c_int, 0)) -@as(f32, 1.0) else if (A > @as(c_int, 0)) @as(f32, 1.0) else @as(f32, 0.0);
}
pub inline fn CEIL(a: anytype) f32 {
    _ = &a;
    return @import("std").zig.c_translation.cast(f32, ceil(a));
}
pub inline fn FMOD(A: anytype, B: anytype) @TypeOf(fmodf(A, B)) {
    _ = &A;
    _ = &B;
    return fmodf(A, B);
}
pub inline fn ATAN2(A: anytype, B: anytype) @TypeOf(atan2f(A, B)) {
    _ = &A;
    _ = &B;
    return atan2f(A, B);
}
pub inline fn SIN(A: anytype) @TypeOf(sinf(A)) {
    _ = &A;
    return sinf(A);
}
pub inline fn COS(A: anytype) @TypeOf(cosf(A)) {
    _ = &A;
    return cosf(A);
}
pub inline fn SQRT(A: anytype) @TypeOf(sqrtf(A)) {
    _ = &A;
    return sqrtf(A);
}
pub inline fn ACOS(A: anytype) @TypeOf(acosf(A)) {
    _ = &A;
    return acosf(A);
}
pub inline fn POW(A: anytype, B: anytype) @TypeOf(pow(A, B)) {
    _ = &A;
    _ = &B;
    return pow(A, B);
}
pub inline fn ISNAN(A: anytype) c_int {
    _ = &A;
    return @import("std").zig.c_translation.cast(c_int, isnan(A));
}
pub inline fn SIN_DEG(A: anytype) @TypeOf(SIN(A * DEG_RAD)) {
    _ = &A;
    return SIN(A * DEG_RAD);
}
pub inline fn COS_DEG(A: anytype) @TypeOf(COS(A * DEG_RAD)) {
    _ = &A;
    return COS(A * DEG_RAD);
}
pub inline fn CLAMP(x: anytype, min: anytype, max: anytype) @TypeOf(if (x < min) min else if (x > max) max else x) {
    _ = &x;
    _ = &min;
    _ = &max;
...
pub inline fn ATAN2DEG(A: anytype, B: anytype) @TypeOf(@import("std").zig.c_translation.cast(f32, ATAN2(A, B)) * RAD_DEG) {
    _ = &A;
    _ = &B;
    return @import("std").zig.c_translation.cast(f32, ATAN2(A, B)) * RAD_DEG;
}
...
// /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/libkern/i386/_OSByteOrder.h:38:17
